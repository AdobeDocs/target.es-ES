...
seo-description: Notas de la versión de versiones anteriores de Target, incluidas las notas de la versión Target Standard/Premium, la plataforma Target y las bibliotecas Javascript de Target (at.js y mbox.js). Las notas de la versión se presentan en orden descendente por mes y año de publicación.
seo-title: Notas de la versión para versiones anteriores
solution: Target
...
### [!DNL Target] Standard/Premium 19.5.1 (21 de mayo de 2019) {#tgt-19-5-1-historica}
...
| Función/Mejora | Descripción |
| --- | --- |
| [!UICONTROL Compositor de experiencias visuales] | El [!UICONTROL Compositor de experiencias visuales] (VEC) incluye las siguientes mejoras para que su funcionamiento sea más rápido y eficiente:<ul><li>La función de ruta DOM ahora está disponible al configurar el rastreo de clics.<br>Para obtener más información, consulte [Rastreo de clics](/help/c-activities/r-success-metrics/click-tracking.md#considerations).</li><li>Utilice el panel Estilos para ver o editar el valor de los estilos existentes para el elemento seleccionado. También puede añadir estilos adicionales.<br>Para acceder al panel Estilos, haga clic en un elemento de página desde el VEC y, a continuación, haga clic en [!UICONTROL Editar] &gt; [!UICONTROL Estilos].<br>El panel Estilos aparece en la parte derecha del VEC. El panel contiene una lista de estilos que le permite editar o agregar al elemento seleccionado. Un editor CSS en tiempo real permite ver cambios y agregar estilos si se siente cómodo utilizando Hojas de estilo en cascada (CSS, Cascading Style Sheets) o si recibe código de su desarrollador.<br>Para obtener más información, consulte [Estilos](/help/c-experiences/c-visual-experience-composer/viztarget-options.md#styles) en *Opciones del Compositor de experiencias visuales*.</li><li>El Editor de texto enriquecido ahora es compatible con elementos anidados HTML 5.<br>Las especificaciones HTML 5 permiten nuevas combinaciones de etiquetas para anidar. La versión anterior del editor de texto enriquecido no permitía el anidamiento nuevo de etiquetas como lo permitía la especificación HTML 5. Como resultado, los elementos anidados seleccionados en el VEC no se gestionaban correctamente, lo que producía cambios HTML no deseados. (TGT-33618)<br>Para obtener más información, consulte [Editar texto/HTML](/help/c-experiences/c-visual-experience-composer/viztarget-options.md#edit-text-html) en las *Opciones del Compositor de experiencias visuales*.</li> |
...
* Ahora puede eliminar carpetas de recursos incluso si contienen imágenes (carpetas que no estén vacías). (TGT-33265)
   ...
   * La representación de ofertas de imágenes en el selector de Recursos de imagen es más rápida y eficaz.
...
* Se ha corregido un problema que provocaba que un pequeño conjunto de informes de Perspectivas devolviera tasas de conversión del 0 % en lugar de las tasas de conversión reales. (TNT-32125)
...
| Función/Mejora | Descripción |
| --- | --- |
| Compositor de experiencias visuales | El Compositor de experiencias visuales (VEC) incluye las siguientes mejoras para que su funcionamiento sea más rápido y eficiente:<ul><li>Ahora puede cancelar la carga de un sitio web en el VEC para desbloquear la edición de una actividad. Esta mejora es útil si, por ejemplo, necesita hacer un pequeño cambio en una actividad, revisar su configuración o añadir código personalizado y no quiere esperar a que se cargue el sitio web. (TGT-31288)<br>Consulte [Cancelación de carga de una página dentro del VEC](/help/c-experiences/c-visual-experience-composer/visual-experience-composer.md#cancel-loading).</li><li>Puede realizar muchas acciones antes de que la página se cargue en VEC o incluso si la página no se carga completamente (por ejemplo, si el código personalizado ya no funciona). Las acciones que no se pueden editar antes de que el sitio web cargue no aparecerán en la IU de Target. (TGT-31288, TGT-31611 y TGT-32602)<br>Consulte [Edición de una página mientras se carga o después de que la página no se haya cargado](/help/c-experiences/c-visual-experience-composer/visual-experience-composer.md#loading).</li><li>El VEC muestra la ruta DOM para que pueda seleccionar fácilmente el elemento que necesite durante la creación o edición de experiencias. (TGT-13422)<br>Consulte [Desplazamiento por elementos utilizando la ruta DOM](/help/c-experiences/c-visual-experience-composer/viztarget-options.md#dom-path).</li></ul> |
...
| Función/Mejora | Descripción |
| --- | --- |
| ![Distintivo de Target Premium](/help/assets/premium.png)<br/>Compatibilidad de [!UICONTROL Permisos empresariales] en las API de [!DNL Target] | Las [API de administrador de Adobe Target](http://developers.adobetarget.com/api/#admin-apis) ahora aprovechan al máximo las mismas capacidades de permisos de Enterprise que se encuentran en la interfaz de usuario de Target. A partir del **21 de febrero de 2019**, los administradores de sistemas podrán acceder mediante programación a los datos del informe, así como crear y administrar actividades, ofertas y audiencias dentro de cualquier espacio de trabajo. Anteriormente, estas acciones estaban limitadas únicamente al espacio de trabajo predeterminado. La compatibilidad con las actividades de Personalización automatizada (AP) se publicará en una versión futura. |
...
* Se ha mejorado el manejo de audiencias a las que se hace referencia en las actividades de Target que se han eliminado en Adobe Audience Manager (AAM). (TGT-23338)
   ...
   * Si intenta combinar varias audiencias con una audiencia eliminada, o si intenta guardar una actividad que hace referencia a una audiencia eliminada, aparecerá un mensaje de advertencia.
   Consulte [Acerca de las audiencias](https://marketing.adobe.com/resources/help/en_US/target/target/c_audiences.html).
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Esta es una versión de mantenimiento y aborda el siguiente problema: </p> <p> 
     ...
     </ul> </p> <p> <p>Importante: Además, la versión 1.6.2 de at.js también contiene todas las mejoras y correcciones incluidas en las versiones 1.6.1 y 1.6.0 de at.js. Estas versiones ya no están disponibles para descargar. Le recomendamos que actualice a la versión 1.6.2 si usa 1.6.1 o 1.6.0. </p> </p> <p>Para obtener más información, consulte <a href="https://marketing.adobe.com/resources/help/en_US/target/ov2/r_target-atjs-versions.html" format="html" scope="external">Detalles de la versión de at.js</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>La IU de Target ya se encuentra disponible en los siguientes idiomas: </p> <p> 
     ...
     </ul> </p> <p>La <a href="https://marketing.adobe.com/resources/help/en_US/target/" format="https" scope="external">documentación de producto de Target</a> se está localizando en estos momentos y se publicará en los idiomas anteriores cuando haya concluido el proceso. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Audiencias </p> </td> 
...
<table id="table_6ADDF3552AD04666B76F2D3F457BB042"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Ofertas </p> </td> 
   <td colname="col2"> <p> Si un usuario tiene el permiso de “Editor”, no podrá editar una oferta que haga referencia a una actividad programada o en directo. </p> <p> <p>Nota: En el caso de clientes de Target Premium que tengan <a href="https://marketing.adobe.com/resources/help/en_US/target/target/property_channel.html" format="html" scope="external">Permisos de usuario de Enterprise</a>, si un usuario selecciona la opción Todos los espacios de trabajo, Target utiliza el permiso más alto del usuario a través de los espacios de trabajo. Si el permiso más alto es “Editor”, Target restringe la edición, como se ha indicado anteriormente </p>. </p> <p>Estas restricciones se aplican a todas las ofertas, no solo a las ofertas creadas en Target. (TGT-27276) </p> </td> 
  </tr> 
  <tr> 
...
* Se ha mejorado el flujo de trabajo al agotar el tiempo de espera de la sesión de Target de un usuario mientras configura opciones en las páginas de Configuración, Audiencias y Recommendations. Cuando el usuario hace clic en Guardar se muestra el mensaje de sesión expirada. Sin embargo, cuando vuelve a iniciar la sesión, un cuadro de diálogo indica que el inicio de sesión se ha realizado correctamente y que la interfaz de usuario permanece en la misma página de Target, sin que se haya producido pérdida de datos. (TGT-25557)
...
<table id="table_1B43199F1AE64E69AE65313B23741444"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><b>18 de julio de 2017</b> </p> <p> Ya está disponible la versión 63 de <span class="filepath">mbox.js</span>. Para obtener más información, consulte <a href="../c-implementing-target/c-implementing-target-for-client-side-web/t-mbox-download/target-download-config-mbox.md#task_4EAE26BB84FD4E1D858F411AEDF4B420" format="dita" scope="local">Descargar mbox.js</a>. </p> <p>En la versión 63 de <span class="filepath">mbox.js</span> se incluyen las siguientes mejoras y correcciones: </p> <p> 
     <ul id="ul_F876FABA804A459D84387102DC38B7DC"> 
      <li id="li_E840AFDFAD394F5E9CDF52FABCA27EF7">Corrige un problema con la generación SDID al utilizar <span class="codeph">mboxDefine()</span> y <span class="codeph">mboxUpdate()</span>. Esto afecta únicamente a los clientes con API de visitante en la página. </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Mensajes de error mejorados cuando un sitio tiene “X-Frame-options” establecido en SAMEORIGIN y no se puede cargar en el Compositor de experiencias visuales (VEC). El mensaje indica al usuario que cambie al Compositor de experiencias mejorado en Configuración &gt; Preferencias. (TGT-17356)
...
### Cambios en la plataforma de Target (18 de julio de 2017)  {#section_08A2B80060FE4833B1BDD12D1AF5E3D6}
  ...
  <tr> 
   ...
   <td colname="col2"> <p><b>18 de julio de 2017</b> </p> <p> Ya está disponible la versión 63 de <span class="filepath">mbox.js</span>. Para obtener más información, consulte <a href="../c-implementing-target/c-implementing-target-for-client-side-web/t-mbox-download/target-download-config-mbox.md#task_4EAE26BB84FD4E1D858F411AEDF4B420" format="dita" scope="local">Descargar mbox.js</a>. </p> <p>En la versión 63 de <span class="filepath">mbox.js</span> se incluyen las siguientes mejoras y correcciones: </p> <p> 
     <ul id="ul_6C88DB6332A94858B278F7F846E2F8EB"> 
      <li id="li_597D15CAD9DA44008FEC01E6BB3CB9A7">Corrige un problema con la generación SDID al utilizar <span class="codeph">mboxDefine()</span> y <span class="codeph">mboxUpdate()</span>. Esto afecta únicamente a los clientes con API de visitante en la página. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="filepath"> at.js </span> </p> </td> 
   <td colname="col2"> <p><b>7 de julio de 2017</b> </p> <p> Ya está disponible la versión 1.0 de <span class="filepath">at.js</span>. Para obtener más información, consulte <a href="../c-implementing-target/c-implementing-target-for-client-side-web/how-to-deployatjs/implementing-target-without-a-tag-manager.md#concept_1E1F958F9CCC4E35AD97581EFAF659E2" format="dita" scope="local">Descargar at.js</a>. </p> <p>En la versión 1.0 de <span class="filepath">at.js</span> se incluyen las siguientes mejoras y correcciones: </p> <p> 
     <ul id="ul_4407D3923CE34CD8AD7120A2580A34DF"> 
      <li id="li_34C8D0572A0340DF99294DD33E352D2C"> <p>Compatibilidad con la carga asíncrona de at.js para cargar las páginas más rápido. </p> </li> 
      <li id="li_BC944624B3104418854140484E682D69"> <p>Soporte para el ocultamiento previo el contenido de la página al cargar at.js de forma asíncrona. </p> </li> 
      <li id="li_F9D0AD095A2A425CB78772DDE8FCCF97"> <p>Mejores mensajes de error cuando se deshabilita el envío de contenido. </p> </li> 
      <li id="li_4B32468665A34FC0AF66C1CD15DE7AFC"> <p>Mejoras de rendimiento al enviar varias actividades. </p> </li> 
      <li id="li_48EAD25A4077411E954CCCDB95058924"> <p>Compatibilidad con YUI Compressor. </p> </li> 
      <li id="li_3598B4223C0A478D956A7EC618BFBCD6"> <p>Realización de informes de errores/fallos para eventos personalizados durante el envío de actividades. </p> </li> 
      <li id="li_28A5DDF1A9D64D66BF8BD0E89E5BD69B"> <p>Corrección de problemas de rendimiento en Microsoft Internet Explorer 11. </p> </li> 
      <li id="li_BB1C11A76FB14341AB7699F2C7753377"> <p>Corrección para la función <span class="codeph">getOffer()</span>, que generaba un error en algunos sitios web. </p> </li> 
      <li id="li_4C7F3DE9A0A346C38E9EDCE21C83843D"> <p>Carga asíncrona de la biblioteca de Target. </p> </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Ya está disponible la versión 0.9.6 de <span class="filepath">at.js</span>. Para obtener más información, consulte <a href="../c-implementing-target/c-implementing-target-for-client-side-web/how-to-deployatjs/implementing-target-without-a-tag-manager.md#concept_1E1F958F9CCC4E35AD97581EFAF659E2" format="dita" scope="local">Descargar at.js</a>. </p> <p>En la versión 0.9.6 de <span class="filepath">at.js</span> se incluyen las siguientes mejoras y correcciones: </p> <p> 
     <ul id="ul_108DF85393614C69988E299485D338FD"> 
      ...
      <li id="li_02904EBAE8D3400092B762F0B28B0C86"> <p>Se ha corregido un problema por el que los complementos de <span class="keyword">Target Classic</span> no se aplicaban correctamente cuando se enviaban varias ofertas predeterminadas a un único mbox. (TGT-22664) Para obtener más información, consulte <a href="https://marketing.adobe.com/resources/help/en_US/tnt/help/t_Using_Plug-Ins.html" format="html" scope="external">Complementos</a> en la documentación de Adobe Target Classic. </p> </li> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>18 de enero de 2017 </p> <p> La versión 0.9.4 de <span class="codeph">at.js</span> contiene las siguientes modificaciones: </p> <p> 
     ...
     </ul> </p> <p>Para obtener información detallada sobre los cambios en cada versión de <span class="codeph">at.js</span>, consulte <a href="https://marketing.adobe.com/resources/help/en_US/target/ov2/r_target-atjs-versions.html" format="html" scope="external">Detalles de la versiones de at.js</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Versión 62 de <span class="codeph">mbox.js</span> </p> </td> 
   <td colname="col2"> <p>18 de enero de 2017 </p> <p> La versión 62 de <span class="codeph">mbox.js</span> presenta las siguientes mejoras: </p> <p> 
     <ul id="ul_1D4351AEB0D74FE4B09196113A4672C1"> 
      <li id="li_653D9C605A0B447AB1FFEE5D22D3AD05"> <p>Se han solucionado los problemas de parpadeo en actividades redirigidas al visualizarlas en navegadores de Google Chrome. (TNT-24928) </p> </li> 
      <li id="li_2196D7CD9B144C0A96AE8B8D13976C69"> <p>Se ha añadido la opción de configuración <span class="codeph">secureOnly</span> que indica si <span class="codeph">mbox.js</span> debería utilizar solo HTTPS o se le debería permitir alternar entre HTTP y HTTPS según el protocolo de la página. Se trata de un ajuste avanzado que se establece en False de manera predeterminada. (TNT-26183) </p> <p>Para obtener más información, consulte <a href="../c-implementing-target/c-implementing-target-for-client-side-web/t-mbox-download/advanced-mboxjs-settings.md#reference_A9C8DAC6DF7743EDBCF1D71F8F20843C" format="dita" scope="local">Configurar mbox.js</a>. </p> </li> 
     </ul> </p> <p>Para obtener información detallada sobre los cambios en cada versión de <span class="codeph">mbox.js</span>, consulte <a href="https://marketing.adobe.com/resources/help/en_US/target/ov/r_mboxjs_change_log.html" format="html" scope="external">Detalles de la versión de mbox.js</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
### Cambios en la plataforma de Target (agosto de 2016) {#section_8D8BA8C628E747338C84564EC34CE0FD}
...
<table id="table_0035B0D7ECD444C68B1B6CB0F150C55E"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> Versión 61 de <span class="filepath">mbox.js</span> </p> </td> 
   <td colname="col2"> <p>23 de agosto de 2016 </p> <p> La versión 61 de <span class="filepath">mbox.js</span> incluye los cambios siguientes en el lanzamiento de agosto: </p> <p> 
     <ul id="ul_DC4E5AB3B48A4D2D9B08B6CDA5DFE8FB"> 
      <li id="li_B52F3AE60D324C2A8FAD03C1495F26D7"> <p> Ahora, la versión 61 de <span class="filepath">mbox.js</span> es la descarga predeterminada en las interfaces de usuario de <span class="keyword">Target Standard/Premium</span> y <span class="keyword">Target Classic</span>. </p> </li> 
      <li id="li_41C2D2E552BF4F8E8A4375AF368F7728"> <p>Se ha añadido la configuración <span class="codeph">optoutEnabled</span> para respaldar la futura función de exclusión de Adobe Experience Cloud. El valor predeterminado es false. Si esta propiedad está habilitada, todas las solicitudes se ejecutan asincrónicamente en el extremo <span class="filepath">/ajax</span>, como en la versión 60. </p> </li> 
     </ul> </p> <p>Si desea más información sobre los cambios realizados en la versión 61 de <span class="filepath">mbox.js</span>, consulte <a href="../c-implementing-target/c-implementing-target-for-client-side-web/t-mbox-download/mboxjs-change-log.md#reference_DBB5EDB79EC44E558F9E08D4774A0F7A" format="dita" scope="local">Detalles de la versión de mbox.js</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_33B60910EAE24BAFA778F280F72FB683"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> Versión 61 de <span class="filepath">mbox.js</span> </p> </td> 
   <td colname="col2"> <p>28 de julio de 2016 </p> <p> La versión 61 de <span class="codeph">mbox.js</span> ya se puede descargar. Actualmente, la versión 61 no es la descarga predeterminada. </p> <p>Para obtener más información, consulte <a href="../c-implementing-target/c-implementing-target-for-client-side-web/t-mbox-download/mboxjs-change-log.md#reference_DBB5EDB79EC44E558F9E08D4774A0F7A" format="dita" scope="local">Detalles de la versión de mbox.js</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_DDC5356FD6B8443EAA6EB81C03ADF73A"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ahora, las descargas de CSV tienen una línea para todos los entornos, incluidos los que no disponen de recomendaciones de entidad (por ejemplo: <code># environment: 1724 
     </code>). </p> </td> 
  </tr> 
 </tbody> 
</table>
...
### Cambios en la plataforma de Target  {#section_8295A808A4CE405C9DA2893E7935238E}

* [La versión 60 de mbox.js](../c-implementing-target/c-implementing-target-for-client-side-web/t-mbox-download/mboxjs-change-log.md#section_3BDAB885FA13444A8D35940A4BFF5825) ahora es la descarga predeterminada.
* Las versiones anteriores a la 50 de mbox.js se han dejado de probar activamente. Si aún no se ha actualizado la implementación, asegúrese de realizar un control de calidad adicional en todas las recopilaciones de informes y entrega de contenido de Target.
* Las campañas de Flash y otros artículos relacionados con Flash se han eliminado de Target.
* Internet Explorer 10 ya no es compatible con la interfaz de Target.
* La compatibilidad de la entrega de contenidos en Internet Explorer 8, 9 y 10 dejará de estar disponible en la próxima versión.

   Se discontinuarán las pruebas activas en una próxima versión para estos navegadores, tras el final de la compatibilidad activa con estos navegadores y Microsoft. Target seguirá entregando contenido a estos navegadores, pero usted debería probar la entrega de contenido y la recopilación de datos para informes.
...
<table id="table_162CC5A0DB324B38A8A4252A18976686"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> Notificaciones de Experience Cloud </td> 
   <td colname="col2"> <p>Las notificaciones de Target son visibles en todas las soluciones de Adobe Experience Cloud. Las notificaciones se envían automáticamente cuando se activa o desactiva una actividad. Estas notificaciones están disponibles para todos los usuarios con acceso a Target Standard/Premium. </p> <p>Las notificaciones también son visibles en Target Standard/Premium. </p> <p>Consulte  <a href="../c-activities/notifications.md#concept_557351F8BB7D40F39A65951A77B79D62" format="dita" scope="local"> Notificaciones </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Mejoras en la interfaz de usuario </td> 
...
* La actualización de la versión 48 de Chrome introdujo un problema que ocasionaba un funcionamiento incorrecto del Compositor de experiencias visuales en Chrome. Google está trabajando en una solución. Para obtener información, consulte [https://code.google.com/p/chromium/issues/detail?id=582603](https://code.google.com/p/chromium/issues/detail?id=582603). Para encontrar una solución alternativa a este problema:
   ...
   * Habilite el Compositor de experiencias mejorado, que se puede configurar desde la pestaña **[!UICONTROL Configuración]** &gt; **[!UICONTROL Preferencias]**.
...
<table id="table_907A952F54084C2A9C61F10E2B7A7BFF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Muestre el elemento clave del diseño de Recommendations. </p> <p>Consulte <a href="https://marketing.adobe.com/resources/help/en_US/target/recs/c_customizing_a_template.html" format="https" scope="external">Personalizar un diseño</a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Haga clic para ver el informe de Analytics completo directamente desde la página de informes de la actividad. </p> <p>Consulte <a href="https://marketing.adobe.com/resources/help/en_US/target/a4t/c_reporting.html" format="https" scope="external">Informes</a>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_DF5B434D639345B4ACE2467B8966A908"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>En la biblioteca de diseños se muestra cuántas actividades publicadas e inactivas usan cada diseño. </p> <p>Consulte <a href="https://marketing.adobe.com/resources/help/en_US/target/recs/t_create_recs_activity.html" format="https" scope="external">Crear una actividad de Recommendations</a>. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Elija un título para mostrarlo cuando se use un diseño concreto. No es necesario que ese título coincida con el que se muestra a los visitantes de la página. </p> <p>Consulte <a href="https://marketing.adobe.com/resources/help/en_US/target/recs/t_create_new_algorithm.html" format="https" scope="external">Crear un nuevo criterio</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1" class="premium"> <p>Recommendations Premium </p> <p>Token de la API </p> </td> 
   <td colname="col2"> <p>Puede establecer el token de la API cliente desde Recommendations Premium. </p> <p>Consulte <a href="https://marketing.adobe.com/resources/help/en_US/target/recs/c_setup.html" format="https" scope="external">Configuración</a>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_46FF5AF77D824ADC941B1E472234F05C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Toda configuración y edición de mbox.js ahora está disponible dentro de Target Standard. Ya no necesita realizar modificaciones en Target Classic. </p> <p>Consulte <a href="https://marketing-beta.adobe.com/resources/help/target/ov/r_advanced_mboxjs_settings.html" format="https" scope="external">Configuración avanzada de mbox.js</a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_6DC206CB52E34498BC762FCCF77807AA"> 
      <li id="li_B26568D642974F17B4B2D6E42CFDC5B9"> <p>Nuevo modo Vista previa para ver diseños con JavaScript </p> <p>Consulte <a href="https://marketing.adobe.com/resources/help/en_US/target/recs/t_create_recs_activity.html" format="https" scope="external">Crear una actividad de Recommendations</a>. </p> </li> 
      ...
      <li id="li_EB8D595EA8A84B37A3262F76543E1B05"> <p>Compatibilidad de nivel de cuenta para escribir una dirección url base y estática con el fin de anteponer a todos los valores de <span class="codeph">entity.thumbnailUrl</span> relativa </p> <p>Consulte <a href="https://marketing.adobe.com/resources/help/en_US/target/recs/c_setup.html" format="https" scope="external">Configuración</a>. </p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_1CF5F2D0CDE84DDC9C445B5CD878EEAA"> 
      ...
      <li id="li_D737754C200844638B536A3BE02E9C5F"> La colección se muestra en el diagrama de segmentación <p>Consulte <a href="https://marketing.adobe.com/resources/help/en_US/target/recs/c_collections.html" format="https" scope="external">Colecciones</a>. </p> </li> 
     </ul> </p> <p>Consulte <a href="https://marketing.adobe.com/resources/help/en_US/target/recs/c_recommendations.html" format="https" scope="external">Recommendations</a>. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_E0D6A9C12B514DE3B3EA753BB4D56662"> 
      ...
      <li id="li_F8C9690CEC974E37B72A85C2FACFAA6D"> FTPS admitido para fuentes de productos <p>Consulte <a href="https://marketing.adobe.com/resources/help/en_US/target/recs/t_feeds_create.html" format="https" scope="external">Crear fuente</a>. </p> </li> 
      <li id="li_3C0FA493C87345E4BE994936DF0D0162"> Los algoritmos personalizados ahora aparecen automáticamente como criterios <p>Consulte <a href="https://marketing.adobe.com/resources/help/en_US/target/recs/c_algorithms.html" format="https" scope="external">Criterios</a>. </p> </li> 
      <li id="li_5B074C9FB3CB46EBA6EB4D8B1098480E"> Reindexación automática por hora de catálogos de producto para clientes sin fuentes <p>Consulte <a href="https://marketing.adobe.com/resources/help/en_US/target/recs/c_catalog_search.html" format="https" scope="external">Buscar en el catálogo</a>. </p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_5A2F2058ACFB455E9F69484CA0C8D3DE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ahora, cuando vea o edite la colección, podrá ver cada uno de los artículos que cumplen los requisitos para entrar en una colección o para excluirlos de ella. </p> <p>Consulte <a href="https://marketing.adobe.com/resources/help/en_US/target/recs/c_recommendations.html" format="https" scope="external">Recommendations</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p class="premium">Recommendations: resultados de búsqueda mejorados </p> </td> 
   <td colname="col2"> <p>Se muestra el número total de artículos que cumplen cada cadena de búsqueda. </p> <p>Consulte <a href="https://marketing.adobe.com/resources/help/en_US/target/recs/c_recommendations.html" format="https" scope="external">Recommendations</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Cargar atributos de clientes en Adobe Analytics </p> </td> 
   <td colname="col2"> <p>Los usuarios de Analytics que capturan los datos de clientes empresariales en una base de datos de administración de la relación con los clientes (CRM) pueden cargar esos datos en Experience Cloud. </p> <p>Una vez que los datos se encuentran en Experience Cloud, se puede crear un segmento de audiencia en Analytics que incluya los atributos del cliente en la definición del segmento y, después, compartir esa audiencia con Target. </p> <p> <p>Nota: Target aún no es capaz de utilizar directamente atributos de cliente sin procesar. </p> </p> <p>Consulte <a href="https://marketing.adobe.com/resources/help/en_US/mcloud/attributes.html" format="https" scope="external">Atributos del cliente</a> en la documentación del producto de Experience Cloud. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Se ha cambiado la ubicación de mbox.js versión 56 a la sección “JavaScript extra” para ejecutarlo antes que el mbox global.

   Todos los ajustes en V56+ tienen espacio de nombres. Si hay funciones declaradas en la sección “JavaScript extra”, debe añadirse el prefijo window a cada una de ellas. Consulte el [registro de cambios en mbox.js](https://marketing.adobe.com/resources/help/en_US/target/ov/r_mboxjs_change_log.html).
...
<table id="table_5D4C3C5695BA4A88BC65E2721CFB073A"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Una prueba multivariable factorial completa compara todas las combinaciones posibles de ofertas en las áreas de contenido para ayudarle a decidir cuál es la mejor combinación de contenido. Las pruebas multivariable también muestran qué contenido de qué áreas contribuye en mayor medida al éxito de la campaña. Un uso habitual de las pruebas multivariable es el que tiene como finalidad optimizar una página entera después de haber usado una prueba A/B para determinar un diseño óptimo. Con este tipo de prueba, puede optimizar los activos concretos de la página (por ejemplo, la imagen principal, titulares o contenido promocional). </p> <p>Consulte <a href="https://marketing.adobe.com/resources/help/en_US/target/mvt/c_multivariate_testing.html" format="https" scope="external">Prueba multivariable</a> para obtener más información. </p> <p>Para ver un vídeo introductorio, visite <a href="https://my.adobeconnect.com/p2k6u8iiu6l/" format="https" scope="external">https://my.adobeconnect.com/p2k6u8iiu6l/</a>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A2A978B157D54E17BD7366ADC04C8FC9"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>El contenido de las diversas actividades Target Standard puede suministrarse en una página desde una llamada al servidor <span class="keyword">Target</span>. </p> <p> <p>Nota: Esto no afecta a la evaluación de prioridades de Target Classic. </p> </p> <p>Para obtener más información sobre el proceso de decisión de prioridades de Target, consulte la <a href="https://marketing.adobe.com/resources/help/en_US/target/target/c_priority.html" format="http" scope="external">ayuda de Target Standard</a>. </p> <p>Para obtener información sobre el modo en que Target determina qué experiencia muestra cuando varias actividades se dirijan a la misma ubicación en una página, consulte <a href="../c-activities/priority.md#concept_1780C11FEA57440499F0047DD6900E0F" format="dita" scope="local"> Prioridad</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_11CD9EE0C9534FF19C9154784C4BFCF0"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> Los clientes de Adobe Analytics pueden seleccionar <a href="https://marketing.adobe.com/resources/help/en_US/target/a4t/" format="http" scope="external"> Analytics como fuente de informes predeterminada </a> durante <a href="../c-activities/t-test-ab/t-test-create-ab/create-a4t.md#task_FE48F7B077C44A5BA015B087428412EF" format="dita" scope="local"> el proceso de configuración de prueba </a>. Ya no es necesaria la selección de todas las métricas o audiencias de éxito que quiere utilizar para filtrar sus resultados. En los informes, puede seleccionar cualquier métrica o segmento de audiencia de éxito definida en Analytics y aplicarla de manera retroactiva a sus informes para realizar filtros amplios o análisis en profundidad de sus resultados de optimización. <p> <p>Nota: Para solicitar acceso a esta función, visite <a href="https://www.adobe.com/go/audiences" format="http" scope="external">http://www.adobe.com/go/audiences</a>. </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Perfil de marketing principal de audiencia en tiempo real </td> 
   <td colname="col2"> Aproveche el <a href="https://marketing.adobe.com/resources/help/en_US/target/a4t/" format="http" scope="external">perfil de marketing principal</a> que unifica el ID y los datos de los visitantes en un único perfil que se puede activar para utilizarlo en todos los programas. Durante el proceso de creación de un segmento en Adobe Analytics, se puede marcar una casilla de verificación para que el segmento esté disponible en la biblioteca de audiencias personalizada de Adobe Target. Un segmento creado en Analytics o Audience Manager puede utilizarse para segmentar visitantes en Target. <p> <p>Nota: Para solicitar acceso a esta función, visite <a href="https://www.adobe.com/go/audiences" format="http" scope="external">http://www.adobe.com/go/audiences</a>. </p> </p> </td> 
  </tr> 
  <tr> 
