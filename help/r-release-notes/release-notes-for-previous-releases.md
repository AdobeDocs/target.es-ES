...
Notas de la versión anterior [!DNL Adobe Target] versiones, incluidas las notas de la versión para [!DNL Target Standard/Premium], el [!DNL Target] y la [!DNL Target] Biblioteca de JavaScript (at.js).
