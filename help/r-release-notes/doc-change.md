...
|  | [Actualización desde at. js 1. x a at. js 2. x](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md) | Se ha actualizado la información sobre la implementación de at. js mediante Adobe Launch, que es el método preferido para la implementación. |
...
|  | [Actualización desde at. js 1. x a at. js 2. x](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md#integrations) | Se ha añadido información sobre la compatibilidad con Adobe Opt-in en at. js 2.1.0. |
...
|  | [Estados e indicadores de fuente](/help/c-recommendations/c-products/feeds.md#section_5DDC2DECF70A42FDAFF2235E91371537) | Se ha actualizado la tabla «Estados de fuentes». |
...
| 24 de abril de 2019 | [Actualización desde at. js 1. x a at. js 2. x](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md#types) | Se agregó una nota a la sección &quot;Tipos de actividades&quot;. |
...
| 8 de abril de 2019 | [Variaciones de datos previstas entre Target y Analytics al utilizar y no utilizar A4T](/help/c-integrating-target-with-mac/a4t/understanding-expected-data-variances.md) | Se ha actualizado [la varianza de datos Esperado al utilizar A 4 T](/help/c-integrating-target-with-mac/a4t/understanding-expected-data-variances.md#expected-using-a4t). |
...
|  | [Actualización desde at. js 1. x a at. js 2. x](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md#response-tokens) | Se ha añadido una nueva sección: Tokens de respuesta. |
...
| 11 de marzo de 2019 | [Notas de la versión de Target (actual)](/help/r-release-notes/release-notes.md),<br>[notas de revisión de Target (versión preliminar)](/help/r-release-notes/target-release-notes.md)y cambios de codificación <br>[TLS (Transport Layer Security)](/help/c-implementing-target/c-considerations-before-you-implement-target/tls-transport-layer-security-encryption.md) | Se ha actualizado el texto para indicar que se producirán cambios TLS el **1 de abril de 2019**. |
...
| 6 de marzo de 2019 | [Actualización desde at. js 1. x a at. js 2. x](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md) | Se ha agregado la fila at_ property a los parámetros de at. js 1. x a la tabla de asignación de payload at. js 2. x. |
...
|  | [Actualización desde at. js 1. x a at. js 2. x](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md) | Nuevo tema y vídeo de formación. |
|  | [Funciones de at.js](/help/c-implementing-target/c-implementing-target-for-client-side-web/cmp-atjs-functions.md) | Tema actualizado para reflejar los cambios con la introducción de at. js 2. x.<br>Existen tres nuevas fucciones disponibles para at. js 2. x.<ul><li>adobe.target.getOffer(options)</li><li>adobe.target.applyOffers(options)</li><li>adobe.target.triggerview (viewname, options)</li></ul> |
|  | [Cómo funciona at.js](/help/c-implementing-target/c-implementing-target-for-client-side-web/c-how-atjs-works/how-atjs-works.md) | Se ha actualizado el tema para reflejar los cambios con la introducción de at. js 2. x. y el vídeo de capacitación agregado. |
...
|  | [Depurar at.js mediante Adobe Experience Cloud Debugger](/help/c-implementing-target/c-implementing-target-for-client-side-web/c-target-debugging-atjs/target-debugging-atjs.md) | Se agregó una nota que explica que las funciones de Solicitud de red de Adobe Experience Cloud y Rastreo de mbox no son compatibles con at. js 2. x. |
...
|  | [Privacidad y Reglamento General de Protección de Datos](/help/c-implementing-target/c-considerations-before-you-implement-target/c-privacy/cmp-privacy-and-general-data-protection-regulation.md) (RGPD) | Ediciones menores e información sobre la funcionalidad de la opción de inclusión y at. js 1.7.0 y at. js 2. x. |
...
|  | [ Adobe Analytics como fuente de informes para Adobe Target (T) ](../c-integrating-target-with-mac/a4t/a4t.md) | Se actualizó la tabla para indicar que A4T admite implementaciones en el lado del servidor. |
