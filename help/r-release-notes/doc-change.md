...
seo-description: En esta página se detallan algunos cambios importantes que hemos realizado en la documentación de Target.
seo-title: Cambios de la documentación
solution: Target
...
| Fecha | Tema | Cambios |
| --- | --- | --- |
| 16 de junio de 2019 | Crear una prueba multivariable | Se han actualizado el texto y las imágenes. |
...
|  | XT: [Crear experiencia](/help/c-activities/t-experience-target/t-xt-create/xt-add-experience.md) | Se han actualizado el texto y las imágenes. |
|  | [Cambio de experiencias en Segmentación de experiencias](/help/c-activities/t-experience-target/t-xt-create/xt-switching-experiences.md) | Se han actualizado el texto y las imágenes. |
|  | XT: [Objetivos y configuración](/help/c-activities/t-experience-target/t-xt-create/xt-goals-and-settings.md) | Se han actualizado el texto y las imágenes. |
|  | XT: [Configurar métricas](/help/c-activities/t-experience-target/t-xt-create/xt-set-metrics.md) | Se han actualizado el texto y la imagen. |
...
|  | [Glosario](/help/c-intro/glossary.md) | Se agregaron y actualizaron varias entradas. |
...
**Nota**: La versión 19.4.1 de Target Standard/Premium era una versión de mantenimiento para actualizar la interfaz de usuario de Adobe Experience Cloud y reflejar los cambios de marca y producto.

| Fecha | Tema | Cambios |
| --- | --- | --- |
| 15 de mayo de 2019 | [Implementación de aplicación de página única](/help/c-implementing-target/c-implementing-target-for-client-side-web/how-to-deployatjs/target-atjs-single-page-application.md#triggerview) | Se ha añadido la nota de que debe activar los `at-view-start` y los eventos `at-view-end`. |
| 14 de mayo de 2019 | [Compositor de experiencias visuales de aplicaciones móviles](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer.md),<br>[Android: configuración de la aplicación móvil](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer-android.md),<br>[iOS: configuración de la aplicación móvil](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer-ios.md) y <br>[configuración del rastreo de clics en el VEC móvil](/help/c-target-mobile-app/c-mobile-visual-experience-composer/set-up-click-tracking-in-the-mobile-vec.md) | Temas nuevos. |
...
| 13 de mayo de 2019 | [Control de calidad de la actividad](/help/c-activities/c-activity-qa/activity-qa.md) | Se ha añadido un elemento a la lista Consideraciones sobre el uso de Modo de control de calidad en una actividad de varias páginas. |
...
|  | [Preguntas más frecuentes de at.js](/help/c-implementing-target/c-implementing-target-for-client-side-web/c-target-atjs-faq/target-atjs-faq.md) | Se ha añadido una nueva pregunta frecuente: ¿Qué tipo de documento HTML requiere at.js? |
...
|  | [Permisos de usuario de Enterprise](/help/administrating-target/c-user-management/property-channel/property-channel.md#faqs) | Se ha añadido una nueva pregunta frecuente: ¿Se registran conversiones de rastreo de clics si una página redireccionada y la dirección URL de la actividad pertenecen a propiedades diferentes? |
| 8 mayo de 2019 | [Vídeos de capacitación para Adobe Target Standard y Premium](/help/c-intro/target-standard-premium-training-videos.md) | Se han actualizado el contenido y los vínculos. |
|  | [Atributos de entidad](/help/c-recommendations/c-products/entity-attributes.md) | Se ha actualizado el texto de la nota de la variable `entity.id`. |
| 1 de mayo de 2019 | [Atributos de entidad](/help/c-recommendations/c-products/entity-attributes.md) | Se ha corregido el uso de mayúsculas en los siguientes nombres de variables:<br>se ha cambiado `pageURL` por `pageUrl`.<br>Se ha cambiado `thumbnailURL` por `thumbnailUrl`. |
| 30 de abril de 2019 | [Opciones del Compositor de experiencias visuales](/help/c-experiences/c-visual-experience-composer/viztarget-options.md) | <ul><li>Se ha añadido una nueva sección: Estilos.</li><li>Se ha añadido una tabla con etiquetas HTML5 que pueden anidarse.</li></ul> |
|  | [Rastreo de clics](/help/c-activities/r-success-metrics/click-tracking.md) | Se ha añadido información sobre la función de la ruta DOM a la sección Consideraciones. |
|  | [Estado de las fuentes e indicadores](/help/c-recommendations/c-products/feeds.md#section_5DDC2DECF70A42FDAFF2235E91371537) | Se ha actualizado la tabla Estados de las fuentes. |
|  | [Trabajar con contenido en la biblioteca](/help/c-experiences/c-manage-content/assets-working.md) | Se ha añadido información sobre la eliminación de carpetas e imágenes de la biblioteca de activos. |
...
| 24 de abril de 2019 | [Actualización de at.js 1.x a at.js 2.x](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md#types) | Se añadió una nota a la sección Tipos de actividades. |
|  | [Comprobar un adbox de imagen de correo electrónico](/help/c-implementing-target/c-non-javascript-based-implementation/testing-email-image-adbox.md) | Ejemplo de código reformateado. |
|  | [Control de calidad de la actividad](/help/c-activities/c-activity-qa/activity-qa.md) | Se han corregido errores menores. |
| 23 de abril de 2019 | [Notas de la versión de Target (versión previa)](/help/r-release-notes/target-release-notes.md) | Se han actualizado las notas de la versión y se ha cambiado la fecha al 30 de abril (era el 29 de abril). |
...
| 19 de abril de 2019 | [Informe Segmentos automatizados](/help/c-reports/c-personalization-insights-reports/automated-segments-report.md#section_740910A52FA646B4AC9452F98C2F5719) | Se ha añadido una nueva pregunta frecuente: ¿Hay alguna lógica en el orden en que los atributos aparecen en una tarjeta de segmento? |
|  | [Fuentes](/help/c-recommendations/c-products/feeds.md#section_5DDC2DECF70A42FDAFF2235E91371537) | Se ha actualizado una nota importante que describe cuándo caducan las entidades cargadas. |
| 16 de abril de 2019 | [Ver informes: preguntas más frecuentes sobre A4T](/help/c-integrating-target-with-mac/a4t/r-a4t-faq/a4t-faq-viewing-reports.md) | Se ha añadido una nueva pregunta frecuente: ¿Puedo cambiar el porcentaje de asignación de tráfico en una actividad que utiliza A4T después de activar la actividad? |
| 15 de abril de 2019 | [Aprovisionamiento inicial: preguntas más frecuentes sobre A4T](/help/c-integrating-target-with-mac/a4t/r-a4t-faq/a4t-faq-initial-provisioning.md) | Se ha añadido una nueva pregunta frecuente: ¿Cómo puedo configurar una actividad de A4T de varias páginas? |
|  | [Requisitos de permisos de usuario](/help/c-integrating-target-with-mac/a4t/account-reqs.md) | Tema actualizado. |
|  | [Problemas conocidos y problemas resueltos](/help/r-release-notes/known-issues-resolved-issues.md) | Se han movido problemas conocidos para los grupos de exclusión a la tabla de problemas resueltos. |
| 11 de abril de 2019 | [adobe.target.getOffers(options) - at.js 2.x](/help/c-implementing-target/c-implementing-target-for-client-side-web/adobe-target-getoffers-atjs-2.md) | Se han actualizado los ejemplos de código. |
...
|  | [Asignación automática](/help/c-activities/automated-traffic-allocation/automated-traffic-allocation.md) | Se ha añadido la siguiente pregunta frecuente: ¿Debo eliminar una experiencia de bajo rendimiento de una actividad de asignación automática para acelerar el proceso de determinar un ganador? |
| 10 de abril de 2019 | [Antes de la implementación](/help/c-integrating-target-with-mac/a4t/before-implement.md) | Pequeñas actualizaciones de texto a la sección &quot;Requisitos de implementación&quot; (se han reorganizado los requisitos). |
|  | [adobe.target.triggerView (viewName, options): at.js 2.x](/help/c-implementing-target/c-implementing-target-for-client-side-web/adobe-target-triggerview-atjs-2.md) | Se ha actualizado el texto del parámetro opciones &gt; página. |
...
|  | [Minimización de los recuentos inflados de visitas y visitantes en A4T](/help/c-integrating-target-with-mac/a4t/c-a4t-troubleshooting/minimizing-inflated-visit-and-visitor-counts-a4t.md) | Se ha actualizado la información sobre A4T y redirecciones en [¿Qué contribuye a los datos parciales?](/help/c-integrating-target-with-mac/a4t/c-a4t-troubleshooting/minimizing-inflated-visit-and-visitor-counts-a4t.md#section_C9C906BEAA7D44DAB9D3C03932A2FEB8) |
|  | [Antes de la implementación](/help/c-integrating-target-with-mac/a4t/before-implement.md#section_A0D2EF18033D4C3997B08A6EBB34C17A) | Se han actualizado los requisitos mínimos para utilizar A4T con redireccionamiento (versión 1.6.2 de at.js). |
|  | [Ofertas de redireccionamiento: preguntas más frecuentes sobre A4T](/help/c-integrating-target-with-mac/a4t/r-a4t-faq/a4t-faq-redirect-offers.md#section_FA9384C2AA9D41EDBCE263FFFD1D9B58) | <ul><li>Se han actualizado los requisitos mínimos para utilizar A4T con redireccionamiento (versión 1.6.2 de at.js).</li><li>Se ha añadido información que describe cómo se cuentan las métricas de datos cuando se produce una visita de Target, pero no se produce ninguna visita de Analytics. </li> |
|  | [Límites](/help/r-troubleshooting-target/target-limits.md#excludedid) | Se ha añadido información sobre los límites del parámetro mbox de `excludedIDs`. |
...
| 5 de abril de 2019 | [Seminario web básico de Adobe Target: Introducción a Recommendations](/help/c-recommendations/recommendations.md#intro-to-recs) | Se ha añadido un vínculo a la grabación del seminario web &quot;Introducción a Recommendations&quot;. |
...
|  | [Notas de la versión de Target (versión previa)](/help/r-release-notes/target-release-notes.md) | Se han actualizado las notas de la versión preliminares para las versiones 19.4.1 y 19.4.2 de Target, ambas programadas para abril de 2019. |
| 4 de abril de 2019 | [Notas de la versión de Target (versión previa)](/help/r-release-notes/target-release-notes.md) | Se han añadido notas de la versión preliminares para las versiones 19.4.1 y 19.4.2 de Target, ambas programadas para abril de 2019. |
| 30 de marzo de 2019 | [Límites](/help/r-troubleshooting-target/target-limits.md#excludedid) | Se ha añadido información sobre los límites del parámetro mbox de `excludedID`. |
| 29 de marzo de 2019 | [Problemas conocidos y problemas resueltos](/help/r-release-notes/known-issues-resolved-issues.md) | Se ha añadido el siguiente problema conocido: Para los sitios web de aplicación de una sola página, la cancelación de la carga no permite editar acciones en el panel [!UICONTROL Modificaciones].<br>Se ha movido el siguiente problema conocido a la sección Problemas resueltos: &quot;la versión v1 de las API de oferta en Adobe I/O trata todas las ofertas creadas a través de Target para que estén en el espacio de trabajo predeterminado.&quot; |
| 28 de marzo de 2019 | [Compositor de experiencias visuales (VEC)](/help/c-experiences/c-visual-experience-composer/visual-experience-composer.md) | Se han añadido las siguientes secciones nuevas:<ul><li>[Cancelación de carga de una página en el VEC.](/help/c-experiences/c-visual-experience-composer/visual-experience-composer.md#cancel-loading)</li><li>[Edición de una página mientras se carga o después de que haya un error en la carga](/help/c-experiences/c-visual-experience-composer/visual-experience-composer.md#loading).</li></ul> |
|  | [Opciones del Compositor de experiencias visuales](/help/c-experiences/c-visual-experience-composer/viztarget-options.md) | Nueva sección: &quot;[Desplazamiento por elementos utilizando la ruta DOM](/help/c-experiences/c-visual-experience-composer/viztarget-options.md#dom-path)&quot;. |
|  | [Problemas conocidos y problemas resueltos](/help/r-release-notes/known-issues-resolved-issues.md#cancel) | Se ha añadido un problema conocido actual sobre la cancelación de la carga de una página en el VEC. |
...
|  | [Sincronización de perfiles en tiempo real para mbox3rdPartyID](/help/c-target/c-visitor-profile/3rd-party-id.md) | Se ha añadido una nota en la parte inferior de la página. |
|  | [Límites](/help/r-troubleshooting-target/target-limits.md)<br>[atributos de entidad personalizados](/help/c-recommendations/c-products/custom-entity-attributes.md#limits) | Se ha añadido información sobre los límites del atributo de entidad personalizado. |
...
|  | [Creación de nuevos criterios](/help/c-recommendations/c-algorithms/create-new-algorithm.md#custom) | Se ha añadido una nueva sección que explica cómo crear agrupaciones basadas en perfiles para algoritmos de popularidad: Uso de una clave de recomendaciones personalizada. |
...
|  | [Ver informes: preguntas más frecuentes sobre A4T](/help/c-integrating-target-with-mac/a4t/r-a4t-faq/a4t-faq-viewing-reports.md) | Se ha añadido la siguiente pregunta frecuente: ¿Admite A4T los grupos de informes virtuales? |
...
| 14 de marzo de 2019 | [Notas de la versión de Target (versión previa)](/help/r-release-notes/target-release-notes.md) | Se ha cambiado la fecha de la versión 19.3.1 de Target Standard/Premium al 29 de marzo de 2019. |
...
| 6 de marzo de 2019 | [Actualización de at.js 1.x a at.js 2.x](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md) | Se ha agregado la fila at_property a la tabla &quot;parámetros at.js 1.x para la asignación de carga at.js 2.x&quot;. |
|  | [Implementación de aplicación de página única](/help/c-implementing-target/c-implementing-target-for-client-side-web/how-to-deployatjs/target-atjs-single-page-application.md) | Se ha añadido una nueva sección: &quot;Utilice TriggerView para asegurarse que A4T funciona correctamente con at.js 2.x y SPA.&quot; |
...
|  | [Comparación entre Recommendations Classic y actividades de Recommendations en Target Premium](/help/c-recommendations/c-recommendations-faq/recommendations-classic-versus-recommendations-activities-target-premium.md) | Se ha añadido información sobre Recommendations como oferta. |
| 28 de febrero de 2019 | [Actividades](/help/c-activities/activities.md) | Se han actualizado el texto y las imágenes. |
|  | [Introducción a Target](/help/c-intro/intro.md) | Se ha añadido Recommendations como oferta en Target Premium. |
...
| 25 de febrero de 2019 | [Notas de versión de Target (actual)](/help/r-release-notes/release-notes.md),<br>[Notas de la versión de Target (versión preliminar)](/help/r-release-notes/target-release-notes.md) y <br>[Cambios de codificación de TLS (Seguridad de la capa de transporte)](/help/c-implementing-target/c-considerations-before-you-implement-target/tls-transport-layer-security-encryption.md) | Se ha actualizado la siguiente información:<br>El 20 de febrero de 2019, la infraestructura de Adobe Target se actualizó en las regiones EMEA, Japón y APAC para no recopilar datos de usuarios finales con dispositivos antiguos o exploradores web que no admiten TLS 1.1 o posterior. La misma actualización está planificada para la región de América del Norte para el **4 de marzo de 2019**. Utilizar TLS 1.2 mejora la seguridad. Es importante que revise los detalles específicos y que planifique los cambios para garantizar una transición sin contratiempos. |
|  | [Actualización de at.js 1.x a at.js 2.x](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md#payload-mapping) | Nueva sección: &quot;Parámetros at.js 1.x para asignación de carga at.js 2.x&quot;. |
|  | [Resolución de problemas relacionados con el Compositor de experiencias mejorado](/help/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/troubleshooting-issues-related-to-the-enhanced-experience-composer-eec.md) | Se ha añadido la columna Nombres de host a las direcciones IP a la lista de direcciones permitidas. |
| 22 de febrero de 2019 | [Configuración de permisos de Enterprise](/help/administrating-target/c-user-management/property-channel/properties-overview.md) | Se ha añadido la sección &quot;Obtener su ID del espacio de trabajo&quot;. |
