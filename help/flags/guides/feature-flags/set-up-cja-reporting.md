...
1. Configura tu [conexión y configuración de datos](https://experienceleague.adobe.com/es/docs/analytics-platform/using/cja-connections/overview) con la información correcta.
...
1. Configure las [configuraciones para cada uno de los conjuntos de datos seleccionados](https://experienceleague.adobe.com/es/docs/analytics-platform/using/cja-connections/create-connection#dataset-settings), uno por uno, en el cuadro de diálogo **Agregar conjuntos de datos**.
