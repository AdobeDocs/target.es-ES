...
description: Encuentre respuestas a preguntas que se plantean a menudo sobre el aprovisionamiento de Analytics para Destinatario (A4T), lo que le permite utilizar Analytics sistema de informes para actividades de Destinatario.
