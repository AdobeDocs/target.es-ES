...
**Última actualización: 20 De Abril De 2020 ([Ver Qué Cambió](r-release-notes/doc-change.md))**

>[!NOTE]
>
>Con la próxima desaprobación de mbox.js el 30 de agosto de 2020, David Son, el administrador de productos de Adobe Destinatario organiza un chat de desarrollador para debatir las ventajas de migrar mbox.js a at.js. Para obtener más información, consulte [Adobe Destinatario Skill Builder: Chat del desarrollador, migre el archivo mbox.js de Adobe Destinatario a at.js](/help/r-release-notes/release-notes.md#skill-builder).
...
- [Tutoriales](https://docs.adobe.com/content/help/en/target-learn/tutorials/overview.html)de Adobe Destinatario: Ofrece tutoriales y vídeos que le ayudarán a sacar el máximo partido del Destinatario.
...
- [API](https://developers.adobetarget.com/api/delivery-api/)del lado del servidor de Destinatario: Describe los recursos que conforman la API de Envío de Adobe Destinatario.
...
- [API](https://developers.adobetarget.com/api/recommendations/)de Destinatario Recommendations: Describe los recursos que conforman la API oficial de Adobe Destinatario Recommendations.
