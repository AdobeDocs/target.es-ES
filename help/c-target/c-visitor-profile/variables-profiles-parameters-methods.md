...
| profile.get('param_name') | La forma correcta de obtener un parámetro de perfil para utilizarlo en una secuencia de comandos de perfil es el método profile.get('param_name'). |
