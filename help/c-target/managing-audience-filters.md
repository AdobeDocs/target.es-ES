...
description: Aprenda a utilizar los filtros de audiencia en Adobe [!DNL Target] para ver datos de grupos de visitantes que comparten una característica o conjunto de características específicos.
