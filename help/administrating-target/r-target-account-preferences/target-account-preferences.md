...
seo-description: Configure las preferencias de su cuenta para que Adobe Target Standard o Target Premium funcionen correctamente con su cuenta.
...
Seleccione el nombre de mbox opcional que está utilizando para publicar actividades de [!DNL Target]. Este mbox global debe estar vacío, lo que significa que no tiene contenido predeterminado. Guarde esta configuración únicamente después de [!DNL at.js] que se instale el [!DNL mbox.js] archivo o la actualización en el sitio.
