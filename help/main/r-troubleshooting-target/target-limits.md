...
### Valor de atributo de perfil In-mbox {#in-mbox}

* **Límite**: 256 caracteres.

  Los valores con más de 256 caracteres se truncan al usar at.js 1.*x*. Recibirá un mensaje de error al enviar valores con más de 256 caracteres al usar at.js 2.*x* o [!DNL Adobe Experience Platform Web SDK]. Los valores no se truncan automáticamente.
...
* **Límite**: 250 caracteres.
  ...
  Para integraciones de [!DNL Delivery API] (at.js 2.*x*), Batch mbox V2 y [!DNL Adobe Experience Platform Web SDK] (alloy.js), los nombres de mbox *can* contienen caracteres alfanuméricos (A-Z, a-z, 0-9) y cualquiera de los siguientes caracteres:

  ```
  - , . _ / = ` : ; & ! @ # $ % ^ & * ( ) _ + | ? ~ [ ] { }
  ```

  Para las integraciones de at.js 1.*x*, los nombres de mbox *no pueden* contener ninguno de los siguientes caracteres:
