...
Al aplicar diferentes estilos, siempre puede revertir los cambios haciendo clic en el icono [!UICONTROL Revertir] que aparece en la esquina superior derecha del panel [!UICONTROL Estilos] después de cambiar cualquier sección. Al hacer clic en el icono [!UICONTROL Revertir] se revertirán todos los cambios en el panel de la sección actual.

Expanda cada sección para editar o agregar estilos, como se explica a continuación. Para guardar los cambios, haga clic en el icono [!UICONTROL Atrás] en la parte superior del panel para volver a la pantalla principal del panel y, a continuación, haga clic en **[!UICONTROL Guardar]**.
...
* **[!UICONTROL Editor CSS]**
  ...
  Observe los puntos azules junto a las opciones [!UICONTROL Tipografía], [!UICONTROL Borde] y [!UICONTROL Tamaño] de la ilustración anterior. Estos puntos indican que ha cambiado estas secciones. Si abre estos paneles de sección, aparecen puntos azules junto a las opciones específicas que ha modificado.
...
Disponible para las actividades [!UICONTROL A/B], [!UICONTROL Automated Personalization] y [!UICONTROL Prueba multivariable].
...
Actualmente, ciertas acciones del VEC, como [!UICONTROL Reorganizar] y [!UICONTROL Mover], suponen que los elementos hermanos de los elementos principales de origen y destino están completamente cargados. Si la carga diferida se produce en los elementos DOM principales (origen o destino), estas acciones del VEC pueden provocar un comportamiento incoherente. Estamos trabajando en un enfoque más confiable para hacer que las acciones del VEC funcionen en elementos DOM cargados de forma diferida. Como solución temporal, puede usar [!UICONTROL Código personalizado] en estos escenarios para procesar sus experiencias.

### [!UICONTROL Cambiar tamaño]

Cambia el tamaño de un elemento en la página. Al seleccionar [!UICONTROL Cambiar tamaño], aparece un controlador en la esquina inferior derecha del elemento que le permite arrastrar esa esquina para cambiar el tamaño. Mantenga pulsada la tecla Mayús para conservar la misma relación de aspecto.
...
Consulte [!UICONTROL Reorganizar] más arriba para obtener más información sobre el comportamiento incoherente con las acciones [!UICONTROL Mover] y [!UICONTROL Reorganizar] debido a la carga lenta de elementos DOM.
