...
En la ficha **[!UICONTROL Administración]** > **[!UICONTROL Compositor de experiencias visuales]** de Target, puede escribir la dirección URL predeterminada del Compositor de experiencias visuales.
...
Haga clic en un elemento resaltado para acceder al menú de opciones disponibles para dicho tipo de elemento. Por ejemplo, puede hacer clic en una imagen y seleccionar **[!UICONTROL Editar > Texto/HTML]** para cambiar el texto, o bien hacer clic en un botón y cambiar el color de fondo. Puede usar los botones de la parte superior izquierda para activar y desactivar las superposiciones.
