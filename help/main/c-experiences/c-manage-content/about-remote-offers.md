...
Utilice las ofertas remotas para alojar contenido fuera de [!DNL Adobe Target] al que [!DNL Target] haga referencia y que entregue a los sitios web de los usuarios. Este contenido puede estar en un sistema de gestión de contenido (CMS) u otro, ya sea por su facilidad de uso o por motivos de seguridad.

>[!NOTE]
>
>Las ofertas remotas se pueden crear en el [!UICONTROL Ofertas] > [!UICONTROL Ofertas de código] o en la [Compositor de experiencias basadas en Forms](/help/main/c-experiences/form-experience-composer.md). No puede crear ni aplicar ofertas remotas en el Compositor de experiencias visuales (VEC). El contenido se insertará en la variable [!DNL Target] ubicaciones de solicitud, por lo que es muy probable que no sean apropiadas para una [!DNL Target] solicitud.
>
...
* Si la oferta se encuentra en el mismo dominio que la variable [!DNL Target] las solicitudes de [!UICONTROL En caché] permite utilizar direcciones URL relativas para describir la ubicación de la oferta.
...
* Utilice la variable [Matriz de selección de ofertas remotas](#reference_B23BEDD29DDD47709A7651AFD27E776B) (abajo) para ayudarle a elegir la oferta más adecuada para su caso específico. Si tiene alguna pregunta, consulte con su representante de cuentas.
...
1. Especifique el tipo de URL de redireccionamiento .
   ...
   Consulte [Tipo de URL de redireccionamiento: En caché o dinámico](#url-type) más abajo para obtener más información.
...
1. Haga clic en el **[!UICONTROL Contenido predeterminado]** lista desplegable y haga clic en **[!UICONTROL Cambiar oferta remota]**.
...
Debe aplicar ofertas remotas mediante la variable [!UICONTROL Compositor de experiencias basadas en formularios]. Actualmente no puede aplicar ofertas remotas mediante el VEC.
...
1. Haga clic en la lista desplegable de la **[!UICONTROL Contenido]** y, a continuación, haga clic en **[!UICONTROL Cambiar oferta remota]**.

   ![Opción Cambiar oferta remota](/help/main/c-experiences/c-manage-content/assets/change-remote-offer.png)

1. Seleccione la oferta remota que desee en el [!UICONTROL Seleccionar oferta remota] y, a continuación, haga clic en **[!UICONTROL Listo]**.
