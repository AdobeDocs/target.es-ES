...
description: Obtenga información sobre cómo crear ofertas de redireccionamiento para que un explorador redirija a una página nueva.
...
Crear ofertas de redireccionamiento en [!DNL Adobe Target] para que un explorador redirija a una página nueva.
...
1. Seleccione las opciones que quiera para personalizar la oferta de redireccionamiento:
   ...
   * **Incluir todos los parámetros de URL:** Active esta opción si desea que todos los parámetros de URL presentes en la página anterior se propaguen en la página a la que se redirige.
...
Debe aplicar ofertas de redireccionamiento usando [[!UICONTROL Form-Based Experience Composer]](/help/main/c-experiences/form-experience-composer.md). Actualmente no puede aplicar ofertas de redireccionamiento usando el [!UICONTROL Visual Experience Composer] (VEC).
...
Este vídeo proporciona una demostración de [!UICONTROL Form-Based Experience Composer], que puede utilizar para crear ofertas de redireccionamiento.
