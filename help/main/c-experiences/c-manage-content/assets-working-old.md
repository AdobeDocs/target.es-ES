...
1. (Opcional) Cambie entre la [!UICONTROL Vista de tarjeta] y la [!UICONTROL Vista de lista], haga clic en el icono [!UICONTROL Vista de tarjeta] o en el icono [!UICONTROL Vista de lista] en la esquina superior derecha de la biblioteca de contenido. También puede usar [!UICONTROL Configuración de vista] para configurar las columnas al ver la [!UICONTROL Vista de lista].
...
Al ver la página [!UICONTROL Ofertas de código], puede realizar las siguientes acciones en un elemento pasando el puntero sobre una oferta o carpeta y, a continuación, seleccionando el icono apropiado.
...
* **Mover**: haga clic en el icono Mover, navegue hasta la ubicación a la que desee mover la oferta o carpeta y, a continuación, haga clic en el icono **[!UICONTROL Soltar]**. Por ejemplo, puede mover una o más carpetas a otra carpeta para crear subcarpetas. Haga clic en [!UICONTROL Borrar selección] para anular la selección de ofertas o carpetas que haya seleccionado.
* **Eliminar**: elimine la oferta o la carpeta. Ver [Consideraciones al eliminar elementos](#delete).

## Opciones de Ofertas de imágenes

Al ver la página [!UICONTROL Ofertas de imágenes], puede realizar las siguientes acciones en un elemento pasando el puntero sobre una oferta o carpeta y seleccionando el icono correspondiente.

La siguiente ilustración muestra los iconos de desplazamiento al ver la [!UICONTROL Vista de tarjeta].
...
La siguiente ilustración muestra los iconos de desplazamiento al ver la [!UICONTROL vista de lista]. Para mostrar los iconos, haga clic en un elemento de la lista.
...
* **Más acciones**: mostrar opciones adicionales en [!UICONTROL Vista de tarjeta].
* **Editar**: edite la carpeta u oferta.
