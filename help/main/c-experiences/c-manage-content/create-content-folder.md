...
description: ¿Cómo se crean carpetas en la biblioteca [!UICONTROL Ofertas]?
title: Aprenda a crear carpetas en la biblioteca [!UICONTROL Ofertas] para guardar ofertas de código e imagen, así como otras carpetas.
...
Cree carpetas en la biblioteca [!DNL Adobe Target] [!UICONTROL Oferta] para albergar ofertas de código y ofertas de imagen. También puede crear carpetas para crear una estructura de subcarpetas.
...
## [!UICONTROL Oferta de código] carpetas

1. Haga clic en **[!UICONTROL Ofertas]** > **[!UICONTROL Ofertas de código]**.

1. Haga clic en **[!UICONTROL Crear carpeta]**.
...
## [!UICONTROL Oferta de imagen] carpetas
...
1. (Opcional) Especifique un **[!UICONTROL Nombre]** descriptivo.
1. (Opcional) Seleccione **[!UICONTROL Privada]** para especificar que la carpeta es privada y que solo usted pueda verla y ver su contenido.
1. (Opcional) Seleccione **[!UICONTROL Se puede volver a ordenar en la vista de lista]** para especificar que usted y otros usuarios puedan reordenar la posición de la carpeta en la [!UICONTROL vista de lista].
