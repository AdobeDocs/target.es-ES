...
El informe [!UICONTROL Offer Level] de la experiencia de bosque aleatorio compara el rendimiento de cada oferta aplicada mediante algoritmos con la misma oferta servida aleatoriamente (Control). De esta manera, las ofertas no deberían comprarse entre sí en esta vista.
