...
description: Aprenda a utilizar Analytics for [!DNL Target] (A4T). La integración con A4T le permite acceder a informes de Adobe Analytics robustos para sus actividades de Adobe  [!DNL Target] 1.
