...
1. Junto a **[!UICONTROL Ajuste preestablecido de Target]**, haga clic en el icono **[!UICONTROL Más opciones]** ( ![Icono de más opciones](/help/main/assets/icons/MoreSmallListVert.svg) ) > **[!UICONTROL Guardar como nuevo]**.

   Se muestra el cuadro de diálogo [!UICONTROL Crear ajuste preestablecido].
...
1. Revise la información de las secciones **[!UICONTROL Filtros]** para asegurarse de que el informe está configurado como desea y, a continuación, especifique el **[!UICONTROL Nombre de ajuste preestablecido]** (hasta 50 caracteres).
...
1. Edite la configuración del informe a su gusto (métricas, intervalos de fechas, audiencias, configuración avanzada, etc.).
   ...
   Después de hacer clic en [!UICONTROL Guardar] después de editar la configuración del informe, aparece un asterisco ( &#42;) después del nombre del ajuste preestablecido para indicar que ha cambiado.

1. Haga clic en el icono **[!UICONTROL Más opciones]** (![Icono de más opciones](/help/main/assets/icons/MoreSmallListVert.svg) ) > **[!UICONTROL Guardar como nuevo]** para crear un ajuste preestablecido nuevo.

### Eliminar un ajuste preestablecido

1. Seleccione el ajuste preestablecido que desee eliminar.
1. Haga clic en el icono **[!UICONTROL Más opciones]** (![Icono de más opciones](/help/main/assets/icons/MoreSmallListVert.svg) ) > **[!UICONTROL Eliminar]**.
...
## [!UICONTROL Métrica de informes] {#section_894ABD7148244806B7CE556EBBA2AD62}

Haga clic en la lista desplegable **[!UICONTROL Métrica del informe]** para seleccionar una [métrica de éxito](/help/main/c-activities/r-success-metrics/success-metrics.md#reference_D011575C85DA48E989A244593D9B9924) diferente o varias métricas que se mostrarán en el gráfico.
...
## [!UICONTROL Público] {#section_70926EB4618945D9AFF2B0564FF3717B}
...
## [!UICONTROL Intervalo de fecha preestablecido]

Haga clic en la lista desplegable **[!UICONTROL Intervalo de fecha preestablecido]** para elegir entre intervalos de fecha preestablecidos.

Seleccione las nuevas fechas **[!UICONTROL inicial]** y **[!UICONTROL final]** del informe. También puede usar los intervalos **[!UICONTROL Inicio de actividad]** y **[!UICONTROL Inicio de actividad - Fin de actividad]**.
...
El cuadro [!UICONTROL Intervalo de fechas] muestra el intervalo de fechas actual del informe. Haga clic en el icono **[!UICONTROL Calendario]** ( ![Icono del calendario](/help/main/assets/icons/Calendar.svg) ) para mostrar un calendario que le permita cambiar el intervalo de fechas del informe.

## Configuración {#section_D99CE462107D45CABE0960F820E1E972}

Para configurar los ajustes del informe:

1. Haga clic en el icono **[!UICONTROL Configuración de informes]** ( ![icono Configuración de informes](/help/main/assets/icons/Setting.svg) ) y realice los cambios que desee (como se explica más abajo).
...
Haga clic en [!UICONTROL Restablecer datos del informe]. Restablezca los datos de informes para eliminar los datos antiguos. Los visitantes actuales permanecen en la actividad.  Esta opción solo está disponible para los que tengan permisos de [!UICONTROL Aprobador].
...
La opción [!UICONTROL Excluir valores extremos] solo se aplica a las actividades con tipos de métrica de ingresos y participación. Para obtener más información, consulte [Exclusión de pedidos extremos](/help/main/c-reports/c-report-settings/excluding-extreme-orders.md#task_2AE7743FFCDD466DAEEB720BE5F33DAA).

## Descargar {#section_77E65C50BAAF4AB79242DB3A8778ADEF}

Haga clic en el icono **[!UICONTROL Descargar]** ( ![Icono de descarga](/help/main/assets/icons/Download.svg) ) para descargar los datos del informe en formato [!DNL .csv] y poder importarlos rápidamente a Excel, Access o cualquier otro programa de análisis de datos.
...
Haga clic en el icono **[!UICONTROL Actualizar]** ( ![Icono de actualización](/help/main/assets/icons/Refresh.svg) ) para actualizar la tabla y la vista de gráfico de un informe sin actualizar toda la página, su configuración o su intervalo de fechas.

## Más opciones {#section_AB1B5C695D7045A0A0AC0E2698D2E7DE}

Haga clic en el icono **[!UICONTROL Más opciones]** ( ![Icono de más opciones](/help/main/assets/icons/MoreSmallListVert.svg) ) para acceder a las opciones [!UICONTROL Guardar como nuevo] y [!UICONTROL Eliminar].

## Ver opciones

Puede ver el informe en varios formatos, según el tipo de actividad. Seleccione la opción que desee.

* **Vista de tabla**: haga clic en el icono **[!UICONTROL Vista de tabla]** ( ![icono de Vista de tabla](/help/main/assets/icons/Table.svg) ) para ver el informe como una tabla.
* **Vista de gráfico**: haga clic en el icono **[!UICONTROL Vista de gráfico]** (![Icono de vista de gráfico](/help/main/assets/icons/GraphTrend.svg) ) para ver el informe como un gráfico.
* **Segmentos automatizados**:(Disponible solo para las actividades [!UICONTROL Automated Personalization] (AP) y [!UICONTROL Segmentación automática] (AT).) Haga clic en el icono **[!UICONTROL Segmentos automatizados] (![icono de Segmentos automatizados](/help/main/assets/icons/AutomatedSegment.svg) ) para ver el [informe de segmentos automatizados](/help/main/c-reports/c-personalization-insights-reports/automated-segments-report.md).
* **Atributos importantes**: (Disponible solo para las actividades [!DNL Automated Personalization] (AP) y [!UICONTROL Segmentación automática] (AT).) Haga clic en el icono **[!UICONTROL Atributos importantes]** ( ![icono de Atributos importantes](/help/main/assets/icons/ViewList.svg) ) para ver el [informe de Atributos importantes](/help/main/c-reports/c-personalization-insights-reports/important-attributes-report.md).
...
* Solo está disponible cuando se visualizan informes en [!UICONTROL Vista de tabla].
...
Haga clic en el icono [[!UICONTROL Contribución de ubicación]](/help/main/c-reports/multivariate-test-reports/location-contribution-report.md) (![icono de Contribución de ubicación](/help/main/assets/icons/LocationContribution.svg) ) para que el informe muestre la contribución por ubicación para las actividades de Prueba multivariable (MVT).

## Experiencias {#section_3A450DE1FA7E43F0AAB73165EC3D1C34}

Solo está disponible cuando se visualiza el informe en [!UICONTROL Visualización de gráfico].
...
Para acceder a la opción [!UICONTROL Metodología de contabilización], mientras ve un informe en modo de gráfico, haga clic en la lista desplegable **[!UICONTROL Mi objetivo principal]** y, a continuación, seleccione la metodología de contabilización.
...
Puede cambiar el modo haciendo clic en la lista desplegable [!UICONTROL Diario] y luego seleccionando una opción acumulativa.

>[!NOTE]
>
>El nombre de esta lista desplegable varía según el modo seleccionado.

Hay cuatro modos para las actividades de [!UICONTROL Segmentación automática]: [!UICONTROL Control diario], [!UICONTROL Segmentación diaria], [!UICONTROL Control acumulativo] y [!UICONTROL Segmentación acumulativa].

El orden predeterminado de representación del gráfico es el siguiente:

* **[!UICONTROL Prueba A/B] (incluidas [!UICONTROL Asignación automática] y [!UICONTROL Automated Personalization])**: orden descendente de creación de la experiencia.
* **[!UICONTROL Segmentación de experiencias] (XT)**: orden de las experiencias en la actividad.
* **[!UICONTROL Prueba multivariable] (MVT)**: Alfabético por nombre de experiencia.
* **[!UICONTROL Recommendations]**: orden descendente de creación de la experiencia.

Cuando trabaje con las opciones de [!UICONTROL Metodología de contabilización], tenga en cuenta las siguientes advertencias:

* Para las [[!UICONTROL actividades de segmentación automática]](/help/main/c-activities/auto-target/auto-target-to-optimize.md), no hay opción para seleccionar &quot;Visitantes&quot; como metodología de conteo. [!UICONTROL Segmentación automática] es el único tipo de actividad que los visitantes no pueden trazar.
