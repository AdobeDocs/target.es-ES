...
- [Target para aplicaciones móviles](https://developer.adobe.com/target/implement/mobile/): Explica cómo [!DNL Target] se puede utilizar para la optimización y personalización de aplicaciones móviles.
