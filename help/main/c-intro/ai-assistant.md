...
>[!NOTE]
>
>La generación de contenido y las perspectivas operativas de los clientes no están disponibles actualmente en [!DNL Target].

## Pasos siguientes

1. Complete las tareas previas en [Habilitar el Asistente de IA de Adobe Experience Platform en Adobe Target](/help/main/c-intro/enabling-ai-assistant.md).
1. Empiece a utilizar el Asistente de IA haciendo preguntas, tal como se explica en [Uso del Asistente de IA en Adobe Target para conocer el conocimiento del producto](/help/main/c-intro/ai-assistant-product-knowledge.md).
