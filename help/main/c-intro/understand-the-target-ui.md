...
![ Notificaciones ](/help/main/c-intro/assets/notifications.png)

Encontrará información más detallada en la página [Adobe Status](https://status.adobe.com/). Para obtener más información, consulte [Actualizaciones de estado del sistema y notificaciones dinámicas](/help/main/c-intro/assets/notifications.png).
