...
+++Detalles
**[!UICONTROL Reorganizar*]*: en el VEC heredado, la opción de reorganizar usaba una superposición para permitir a los usuarios cambiar la posición de un elemento dentro de su grupo relacionado. El movimiento se limitaba a cambiar el orden entre los elementos del mismo nivel.
...
**Cambiar tamaño**: La característica [!UICONTROL Cambiar tamaño] se encuentra en el panel [!UICONTROL Propiedades] en la sección [!UICONTROL Tamaño]. Los usuarios pueden ajustar directamente la anchura y la altura de un elemento. La configuración avanzada incluye:
...
**Mover**: La opción [!UICONTROL Mover] se encuentra en el panel [!UICONTROL Propiedades] en la sección [!UICONTROL Posición]. Esta opción permite a los usuarios:
...
El carril [!UICONTROL Propiedades] actualizado también admite estilos en línea personalizados, lo que ofrece flexibilidad cuando las opciones preestablecidas no satisfacen las necesidades de diseño.

**[!UICONTROL Ocultar]**: la característica [!UICONTROL Ocultar] se encuentra en el panel [!UICONTROL Propiedades]. Después de seleccionar un elemento, haga clic en [!UICONTROL Ocultar elemento] para quitarlo de la vista sin eliminarlo. Esto resulta útil para administrar la visibilidad durante el diseño o la vista previa.

**[!UICONTROL Quitar]**: Se puede obtener acceso a la característica [!UICONTROL Quitar] a través del panel [!UICONTROL Propiedades]. Después de seleccionar un elemento, haga clic en Quitar elemento para eliminarlo de la página. Esta acción elimina permanentemente el elemento del diseño.

+++

## ¿Puedo contraer los carriles de [!UICONTROL Componentes], [!UICONTROL Modificaciones] y [!UICONTROL Propiedades] para poder ampliar el panel [!UICONTROL Diseño]? {#collapse}

+++Detalles

Sí, puede contraer estos raíles para permitirle expandir el lienzo de [!UICONTROL Diseño] y facilitar así la edición. A continuación se muestra cómo:
...
**Contraer el carril [!UICONTROL Componentes]**
...
**Contraer el carril [!UICONTROL Modificaciones]**
...
**Contraer el carril [!UICONTROL Propiedades]**

Para contraer el carril de [!UICONTROL Propiedades] y ampliar el lienzo de [!UICONTROL Diseño], haga clic en el icono [!UICONTROL Mostrar/Ocultar propiedades] ( ![Icono de propiedades](/help/main/assets/icons/Propertie.svg) ) a la derecha del carril para contraer o mostrar el carril de [!UICONTROL Propiedades].

+++

## ¿Siguen estando disponibles los estados [!UICONTROL Guardar como borrador] y [!UICONTROL Sincronizando]?

+++Detalles
Con las últimas actualizaciones en la interfaz de usuario, los estados [!UICONTROL Guardar como borrador] y [!UICONTROL Sincronizando] ya no están disponibles. Para obtener más información, consulte Estados en [Aplicar filtros a la lista de actividades](/help/main/c-activities/activities.md#filters) en *[!UICONTROL Información general de actividades]*.
...
+++Detalles
La interfaz de usuario [!UICONTROL Biblioteca de ofertas] requiere definiciones de atributos coherentes para todas las ofertas. Al crear una oferta solo de actividad (ad hoc), los usuarios también deben especificar un nombre de oferta. Esta información aparece en [!UICONTROL Compositor de experiencias basadas en formularios], lo que facilita la identificación de ofertas sin revisar el código o el contenido.
...
+++Detalles
Los vínculos de vista previa de [!UICONTROL Fragmento de experiencia] están disponibles en la ventana emergente de [!UICONTROL Información rápida], que se muestra al hacer clic en el icono de información ( ![Icono de información](/help/main/assets/icons/InfoOutline.svg) ) correspondiente al fragmento seleccionado.
...
+++Detalles
Ahora, los entornos predeterminados son los últimos que usa el cliente. Para cambiar de entorno, usa el selector [!UICONTROL Entorno] en la esquina superior derecha de la interfaz de usuario de [!UICONTROL Búsqueda en el catálogo].
