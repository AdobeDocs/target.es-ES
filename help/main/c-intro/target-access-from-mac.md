...
description: Obtenga información sobre cómo acceder a  [!DNL Target] desde Adobe Experience Cloud, establecer tu organización predeterminada y cambiar el idioma de la [!DNL Target] IU y documentación de.
...
1. Haz clic en el **[!UICONTROL icono de la aplicación]** en la barra de navegación y, a continuación, haz clic en **[!UICONTROL Destino]**.
...
1. (Opcional) Para establecer la organización predeterminada cuando inicia sesión en [!DNL Experience Cloud], haga clic en **[!UICONTROL Preferencias]** en el avatar de perfil y, a continuación, establezca la organización predeterminada.
...
1. Después de iniciar sesión en [!DNL Adobe Experience Cloud] o [!DNL Target], haz clic en el avatar de perfil y luego haz clic en **[!UICONTROL Preferencias]**.
...
1. En la sección **[!UICONTROL Idiomas preferidos]** de la página [!UICONTROL Cuenta], **[!UICONTROL Agregar]**.
