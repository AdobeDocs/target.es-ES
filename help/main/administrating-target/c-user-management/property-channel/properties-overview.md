...
Tendrá que pasar el ID de espacio de trabajo para aprovechar los permisos de Enterprise en [las API de Target](https://developer.adobe.com/target/implement/server-side/).
...
1. Actualice su [!DNL Target] implementación con el código de implementación obtenido en el paso anterior.
   ...
   * **Mediante la función targetPageParamsAll() :** Inserte el siguiente código en la variable `<head>` sobre la referencia de at.js.
      ...
      Para obtener más información sobre cómo hacerlo con at.js, consulte [targetPageParamsAll](https://developer.adobe.com/target/implement/client-side/atjs/atjs-functions/targetpageparamsall/).
