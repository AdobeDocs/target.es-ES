...
Deberá pasar el ID de espacio de trabajo para aprovechar los permisos de Enterprise en [API de Target](https://developer.adobe.com/target/implement/server-side/){target=_blank}.
