...
Para administrar las direcciones URL incluidas en la lista de permitidos, haga clic en **[!UICONTROL Administration]** > **[!UICONTROL Allowlisted URLs]**.
...
1. Haga clic en **[!UICONTROL Add URL]**.
...
1. Utilice el campo **[!UICONTROL Search URLs]** para filtrar la tabla.
