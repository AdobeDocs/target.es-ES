...
Para obtener información detallada, consulte [Planificar e implementar Recommendations](https://experienceleague.adobe.com/es/docs/target-dev/developer/recommendations){target=_blank} en la **[!DNL Adobe Target]Guía para desarrolladores**.
