...
### ¿Recomienda utilizar el Adobe? [!UICONTROL Segmentación automática] con una división 90 (Control)/10 (Segmentación) hasta que se crean los modelos?
...
* Una vez publicada una actividad, [!UICONTROL Segmentación automática] considera hasta los últimos 45 días de datos servidos aleatoriamente al intentar crear modelos (por ejemplo, tráfico de control, además de algunos datos servidos aleatoriamente extra que mantiene el algoritmo).
...
* Dado que los modelos se crean según la experiencia, sustituir una experiencia por otra significa que se debe recopilar tráfico suficiente (al menos 50 conversiones) para la nueva antes de poder volver a crear los modelos personalizados.
...
+++Respuesta Puede empezar a ver los resultados de su [!UICONTROL Segmentación automática] pruebe después de tener al menos dos experiencias con los modelos creados (marca de verificación verde) para la experiencia que tienen los modelos generados.
...
+++Respuesta
[!DNL Target] crea un modelo por experiencia, por lo que eliminar una experiencia significa [!DNL Target] crea un modelo menos y no afectará a los modelos del resto de experiencias.
...
A veces, las actividades no salen como se esperaba. Estos son algunos de los posibles desafíos a los que podría enfrentarse al usar [!UICONTROL Segmentación automática] y algunas soluciones sugeridas.
...
+++Sugerencias para solucionar problemas Existen cuatro factores necesarios para que una actividad de AT genere un alza:
