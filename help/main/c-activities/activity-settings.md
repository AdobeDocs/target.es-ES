...
description: Aprenda a utilizar la configuración de actividad en Adobe [!DNL Target] para administrar el objetivo, la prioridad y la duración de las actividades.
...
Uso [!UICONTROL Configuración de actividades] in [!DNL Adobe Target] para administrar el objetivo, la prioridad y la duración de las actividades.
...
1. Establezca la prioridad de actividades.
   ...
   Si esta opción no está habilitada en [!UICONTROL Administration] > [!UICONTROL Informes] (el valor predeterminado), especifique una prioridad: Baja, Media o Alta.
...
## Vídeo de formación: Configuración de actividades ![Distintivo de tutorial](/help/main/assets/tutorial.png)
