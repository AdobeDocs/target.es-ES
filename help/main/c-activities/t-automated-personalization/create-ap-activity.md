...
1. En el [!DNL Target] [!UICONTROL Actividades] lista, haga clic en **[!UICONTROL Crear actividad]** > **[!UICONTROL Automated Personalization]**.
   ...
   ![Crear actividad: Automated Personalization](/help/main/c-activities/t-automated-personalization/assets/ap_create-new.png)

1. Para usar la variable [!UICONTROL Compositor de experiencias visuales] (VEC), haga clic en **[!UICONTROL Visual (predeterminado)]**.

   ![Cuadro de diálogo Crear actividad de Automated Personalization](/help/main/c-activities/t-automated-personalization/assets/ap_url-new.png)
...
1. (Condicional) Si es un [!DNL Target] Cliente Premium, [elegir un espacio de trabajo](/help/main/administrating-target/c-user-management/property-channel/property-channel.md).
...
1. Para asignar un nombre a la actividad, haga clic en el botón **[!UICONTROL Nombre]** y escriba el nombre de la actividad.
   ...
   ![Campo Nombre](/help/main/c-activities/t-automated-personalization/assets/ab_newname-new.png)
...
1. (Condicional) Haga clic en **[!UICONTROL Ofertas]** para seleccionar elementos de contenido y asignarlos a grupos de informes o para permitir que solo determinados visitantes vean determinadas ofertas con segmentación.
   ...
   ![Icono de carpeta al pasar el ratón por encima](/help/main/c-activities/t-automated-personalization/assets/icon-folder.png)
   ...
   ![Opciones del grupo de informes](/help/main/c-activities/t-automated-personalization/assets/report-group-options.png)
