...
>
>Anteriormente, las actividades se guardaban primero en la interfaz de usuario de [!DNL Target] y luego se sincronizaban con el sistema de entrega de [!DNL Target], que requería esos estados intermedios. Como ya no es así, se han eliminado esos estados.
>
