...
| Acción | Descripción |
| --- | --- |
| [!UICONTROL Editar] | Cambia la actividad. Todas las actividades se pueden editar.<P>Para obtener más información sobre las distintas formas de editar actividades, consulte [Editar una actividad o guardar como borrador](/help/main/c-activities/edit-activity.md). |
