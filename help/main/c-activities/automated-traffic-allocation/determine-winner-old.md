...
description: Aprenda a interpretar los resultados de una actividad A/B de [!UICONTROL asignación automática] en Adobe [!DNL Target] mediante el examen de indicadores importantes, como el alza y la confianza.
