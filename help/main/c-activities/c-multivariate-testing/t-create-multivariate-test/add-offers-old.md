...
1. Haz clic en una oferta de texto/HTML de tu página y, a continuación, haz clic en **[!UICONTROL Cambiar texto/HTML]**.

   ![Cambiar texto/HTML](/help/main/c-activities/c-multivariate-testing/t-create-multivariate-test/assets/changehtml.png)

1. Haga clic en **[!UICONTROL Agregar oferta de texto/HTML]**, asigne un nombre a la oferta y escriba o pegue el código de la oferta de texto/HTML.
