...
Para mostrar una página diferente después de que se abra el VEC, haga clic en el icono **[!UICONTROL Configurar]**, seleccione **[!UICONTROL Entrega de páginas]** y, a continuación, especifique la dirección URL.
