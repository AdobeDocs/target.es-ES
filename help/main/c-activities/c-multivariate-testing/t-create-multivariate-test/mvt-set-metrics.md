...
description: Obtenga información sobre cómo especificar métricas en una [!DNL Adobe Target] [!UICONTROL Prueba multivariable] actividad para determinar si una visita es satisfactoria, como [!UICONTROL Conversión], [!UICONTROL Ingresos], y [!UICONTROL Participación].
title: ¿Cómo configuro las métricas de objetivo en una? [!UICONTROL Prueba multivariable] ¿Actividad de (MVT)?
...
# Definir métricas para una [!UICONTROL Prueba multivariable] actividad

Uso de métricas en una [!DNL Adobe Target] [!UICONTROL Prueba multivariable] para determinar si una visita es satisfactoria.
