...
1. Haz clic en **[!UICONTROL Vista previa]** para [obtener una vista previa de tus experiencias](/help/main/c-activities/c-multivariate-testing/t-create-multivariate-test/preview-experiences.md).
   ...
   Puede ver cada experiencia y excluir aquellas que no quiere incluir en la prueba. Para excluir una o más experiencias, selecciona las casillas que desees y luego haz clic en **[!UICONTROL Excluir]** .
...
1. Elija el público y el porcentaje de visitantes correspondiente que desea que participen de la actividad.
