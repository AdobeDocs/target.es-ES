...
Para especificar la configuración avanzada, haga clic en el icono **[!UICONTROL More]** ( ![icono Más](/help/main/assets/icons/MoreSmallList.svg) ) en la sección [!UICONTROL My Primary Goal] y, a continuación, haga clic en **[!UICONTROL Advanced Settings]**.
