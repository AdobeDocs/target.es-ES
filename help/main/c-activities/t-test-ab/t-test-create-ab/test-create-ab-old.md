...
>[!NOTE]
>
>Además de la actividad manual (predeterminada) [!UICONTROL Prueba A/B] (que se describe en este artículo), [!DNL Target] proporciona dos tipos adicionales de actividades de [!UICONTROL Prueba A/B]: [!UICONTROL Asignación automática] y [!UICONTROL Segmentación automática].
>
...
1. (Condicional) Si eres [cliente de Target Premium](/help/main/c-intro/intro.md#premium), en la lista desplegable **[!UICONTROL Elegir Workspace]**, elige [espacio de trabajo](/help/main/administrating-target/c-user-management/property-channel/property-channel.md).
   ...
   La opción [[!UICONTROL Elegir lugar de trabajo]](/help/main/administrating-target/c-user-management/property-channel/property-channel.md) de la ilustración anterior es una característica de [Target Premium](/help/main/c-intro/intro.md) que podría no mostrarse si su organización tiene una licencia de [!UICONTROL Target Standard].

1. En el cuadro **[!UICONTROL Introducir URL de actividad]**, especifique la [URL de actividad](/help/main/c-activities/t-test-ab/t-test-create-ab/ab-activity-url.md) y luego haga clic en **[!UICONTROL Crear]**.
...
1. Haga clic en **[!UICONTROL Actividad sin título]** en la parte superior del VEC y, a continuación, especifique un nombre para la actividad en el espacio proporcionado.
