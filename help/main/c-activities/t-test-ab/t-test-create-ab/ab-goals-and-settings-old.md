...
La sección [!UICONTROL Configuración avanzada] de la página [!UICONTROL Objetivos y configuración] le permite configurar las siguientes opciones:

Para especificar la configuración avanzada, haga clic en el icono **[!UICONTROL Más]** (los puntos suspensivos verticales) y, a continuación, haga clic en **[!UICONTROL Configuración avanzada]**, como se muestra en la siguiente ilustración.
