...
1. Seleccione los elementos que desee cambiar y realice los cambios necesarios.
   ...
   ![Público de todos los visitantes](/help/main/c-activities/t-experience-target/t-xt-create/assets/all-visitors.png)
...
1. Para crear experiencias adicionales, haga clic en **[!UICONTROL Agregar segmentación de experiencias]**.
...
1. Seleccione una o más audiencias para segmentar con la experiencia y luego haga clic en **[!UICONTROL Listo]**.
...
Puede hacer clic en el icono [!UICONTROL Editar] (los puntos suspensivos verticales) de una experiencia en una actividad de [!UICONTROL Segmentación de experiencias] y elegir de las siguientes opciones, según sea necesario:
...
En la página **[!UICONTROL Experiencias]** (el primer paso del flujo de trabajo guiado de tres pasos), haga clic en los puntos suspensivos verticales > **[!UICONTROL Eliminar]**.
...
Puede copiar una experiencia en una actividad [!UICONTROL Segmentación de experiencias] para poder realizar cambios menores sin tener que volver a crear la experiencia completa.

En la página **[!UICONTROL Experiencias]** (el primer paso del flujo de trabajo guiado de tres pasos), haga clic en los puntos suspensivos verticales > **[!UICONTROL Duplicar]**.
