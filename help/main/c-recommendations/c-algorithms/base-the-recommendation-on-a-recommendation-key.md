...
description: Aprenda a utilizar las recomendaciones basadas en claves que utilizan el contexto de comportamiento del visitante para mostrar resultados relevantes en el Adobe [!DNL Target] Actividades de Recommendations.
...
Para obtener más información sobre la creación de criterios y la definición de sus tipos de algoritmos y algoritmos, consulte [Crear criterios](/help/main/c-recommendations/c-algorithms/create-new-algorithm.md).
...
[!DNL Target] también ofrece a los especialistas en marketing la opción de observar el comportamiento del visitante en una sola sesión o en varias:
...
Los siguientes algoritmos están disponibles con [!UICONTROL Basado en el carro] tipo de algoritmo:

### [!UICONTROL Los ususarios que vieron esto, vieron aquello]
...
El [!UICONTROL Basado en popularidad] el tipo de algoritmo le permite hacer recomendaciones basadas en la popularidad general de un elemento en su sitio o en la popularidad de elementos dentro de la categoría, marca, género, etc. favoritos o más vistos de un usuario.

Los siguientes algoritmos están disponibles con [!UICONTROL Basado en popularidad] tipo de algoritmo:
...
Muestra la &quot;x superior&quot; donde *x* es un arbitrario [!DNL Analytics] métrica. Al utilizar datos de comportamiento de mboxes, puede utilizar Más vendidos o Más visitados (x = &quot;Vendido&quot; o x = &quot;Visto&quot;). Si utiliza datos de comportamiento de [!DNL Adobe Analytics], puede usar x = &quot;Adiciones al carro de compras&quot; u otro [!DNL Analytics] métrica.

## [!UICONTROL Basado en elementos]

El [!UICONTROL Basado en elementos] el tipo de recomendación permite hacer recomendaciones basadas en la búsqueda de artículos similares a un artículo que el usuario está viendo o ha visto recientemente.

Los siguientes algoritmos están disponibles con [!UICONTROL Basado en elementos] tipo de algoritmo:
...
Los siguientes algoritmos están disponibles con [!UICONTROL Basado en el usuario] tipo de algoritmo:
...
El algoritmo de artículos vistos recientemente devuelve el resultado específico de un determinado [entorno](/help/main/administrating-target/hosts.md). Si dos sitios pertenecen a entornos distintos y un visitante alterna entre ellos, cada sitio muestra solo los elementos visualizados recientemente desde el sitio adecuado. Si dos sitios se encuentran en el mismo entorno y un visitante cambia entre los dos, el visitante verá los mismos artículos vistos recientemente en ambos.
...
>[!NOTE]
>
>[!UICONTROL Artículos vistos recientemente] respeta tanto la configuración global de exclusiones como la configuración de recopilación seleccionada para la actividad. Si un elemento queda excluido por una exclusión global o no está contenido en la colección seleccionada, no se mostrará. Por lo tanto, al utilizar un [!UICONTROL Artículos vistos recientemente] , la configuración &quot;Todas las colecciones&quot; debería usarse generalmente.
...
Esta funcionalidad significa que puede utilizar [!DNL Target] para agregar una personalización además de sus recomendaciones calculadas sin conexión o listas personalizadas. Esto combina el poder de sus científicos e investigadores de datos con la entrega probada y comprobada de Adobe, el filtrado en tiempo de ejecución, las pruebas A/B, la orientación, los informes, las integraciones y más.
...
Las siguientes claves de recomendación están disponibles en [!UICONTROL Clave de recomendación] lista desplegable:
...
Utilice el [!UICONTROL Elemento actual] clave de recomendaciones del sitio en:
...
Utilice el [!UICONTROL Último artículo comprado] clave de recomendaciones del sitio en:
...
Utilice el [!UICONTROL Último artículo visto] clave de recomendaciones del sitio en:
...
Utilice el [!UICONTROL Categoría actual] clave de recomendaciones del sitio en:
