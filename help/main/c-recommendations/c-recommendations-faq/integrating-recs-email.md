...
La mayoría de los clientes de correo electrónico no permiten solicitudes POST. Por lo tanto, no se recomienda esta API para casos de uso de hora de apertura. Algunos clientes de correo electrónico, como Gmail o Outlook, podrían guardar el contenido en caché o bloquear la imagen y exigir al destinatario que permita activamente que se muestre la imagen.
...
| `mbox` | *mboxName* | El nombre de mbox que se utiliza para la segmentación. | La misma validación que para todas las llamadas de mbox.<br>Límite de 250 caracteres.<br>No puede contener ninguno de los siguientes caracteres: `', ", %22, %27, <, >, %3C, %3E` |
