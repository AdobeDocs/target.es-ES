...
* Para utilizar esta integración, el método de implementación preferido es tener [[!DNL Adobe Experience Platform]](https://experienceleague.adobe.com/en/docs/experience-platform){target=_blank} and [!DNL Target] implemented through the [[!DNL Adobe Experience Platform Web SDK]](https://experienceleague.adobe.com/en/docs/target-dev/developer/client-side/aep-web-sdk){target=_blank}.
  ...
  Si actualmente no tiene el [!DNL Adobe Experience Platform Web SDK] implementado, también puede crear un [[!DNL Adobe Analytics] conexión de origen](https://experienceleague.adobe.com/en/docs/experience-platform/sources/ui-tutorials/create/adobe-applications/analytics) para introducir los datos en [!DNL Adobe Experience Platform]. Si planea utilizar este método, debe seleccionar una [!DNL Analytics] junto con el grupo de informes [!DNL Adobe Experience Platform] zona protegida que utiliza con [!DNL Customer Journey Analytics].

  ![Opción de zona protegida en el cuadro de diálogo Configuración de informes](/help/main/c-integrating-target-with-mac/cja/assets/aep-sandbox.png)
