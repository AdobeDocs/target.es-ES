...
Para obtener más información sobre la documentación de la API de Target, consulte   [API de Target y SDK de NodeJS](https://developer.adobe.com/target/implement/server-side/){target=_blank}.
