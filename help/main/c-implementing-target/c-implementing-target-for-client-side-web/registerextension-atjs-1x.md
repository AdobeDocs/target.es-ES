...
description: Utilice la función registerExtension() para el Adobe [!DNL Target] Biblioteca JavaScript at.js para registrar una extensión específica. (at.js 1.x)
