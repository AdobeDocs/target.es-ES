...
>[!NOTE]
>
>Consulte la [Documentación de la API de envío](https://developer.adobe.com/target/before-administer/){target=_blank} para obtener información sobre los tipos aceptables para todos los campos que aparecen a continuación.
