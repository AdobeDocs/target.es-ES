...
description: Utilice adobe.target.sendNotifications() para at.js para enviar notificaciones a la variable [!DNL Target] edge cuando se procesa una experiencia que no usa applyOffer(s) . (at.js.2.1 +)
