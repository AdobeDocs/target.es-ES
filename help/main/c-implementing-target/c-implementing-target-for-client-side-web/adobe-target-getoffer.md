...
description: Utilice la función adobe.target.getOffer() y sus opciones para el Adobe [!DNL Target] biblioteca at.js para activar solicitudes para obtener un [!DNL Target] oferta.
title: ¿Cómo utilizo la función adobe.target.getOffer() ?
feature: at.js
role: Developer
...
| timeout | Número | No | Tiempo de espera en milisegundos. Si no se especifica, se usará el tiempo de espera predeterminado en at.js.<br>El tiempo de espera predeterminado se puede establecer desde la variable [!DNL Target] IU en [!UICONTROL Administración > Implementación]. |
