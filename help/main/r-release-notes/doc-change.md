...
| Fecha | Tema | Cambios |
|--- |--- |--- |
| 17 de enero | [[!UICONTROL Visual Editing Helper] extensión](/help/main/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/visual-editing-helper-extension.md) | Se ha agregado una nueva sección: Cambios en la extensión [!UICONTROL Visual Editing Helper] (17 de enero de 2026). |
...
| Fecha | Tema | Cambios |
|--- |--- |--- |
| 20 de noviembre | [Crear una actividad de Recommendations](/help/main/c-recommendations/t-create-recs-activity/create-recs-activity.md) | Se ha añadido la nota siguiente en el paso 5: <ul><li>[!UICONTROL Recommendations] actividades solo admiten una modificación/recomendación a la vez. Para varias recomendaciones, puede crear varias actividades [!DNL Recommendations] o usar pruebas A/B o XT.</li></ul> |
...
|  | [Selectores de elementos utilizados en el Compositor de experiencias visuales](/help/main/c-experiences/c-visual-experience-composer/vec-selectors.md) | Se agregó la opción &quot;[!UICONTROL Use preferred selectors]&quot;. |
...
|  | [Planificar e implementar Recommendations](https://experienceleague.adobe.com/en/docs/target-dev/developer/recommendations#set-up-your-recommendations-catalog){target=_blank} en la *[!DNL Target]Guía para desarrolladores* | Se agregó una nota sobre la precaución al actualizar [!DNL Recommendations] [!UICONTROL Catalogs] a través de [!DNL Target Delivery API]. |
...
| 21 de julio | [[!DNL Target] Preguntas frecuentes sobre la actualización de IU](/help/main/c-intro/updated-ui-faq.md#collapse) | Se ha agregado una nueva pregunta frecuente: ¿Puedo contraer los carriles [!UICONTROL Components], [!UICONTROL Modifications] y [!UICONTROL Properties] para poder ampliar el panel [!UICONTROL Design]? |
...
| Julio de 14 | [Información general sobre las actividades](/help/main/c-activities/activities.md#filters) | Se agregó información sobre la obsolescencia de los estados [!UICONTROL Save as Draft] y [!UICONTROL Syncing] en la interfaz de usuario actualizada. |
|  | [[!DNL Target] Preguntas frecuentes sobre la actualización de IU](/help/main/c-intro/updated-ui-faq.md) | Se agregó información sobre la obsolescencia de los estados [!UICONTROL Save as Draft] y [!UICONTROL Syncing] en la interfaz de usuario actualizada. |
...
| Fecha | Tema | Cambios |
|--- |--- |--- |
| 2 de junio | [[!UICONTROL Visual Experience Composer] prácticas recomendadas y limitaciones](/help/main/c-experiences/c-visual-experience-composer/experience-composer-best-practices.md#ext) | Se ha añadido la siguiente limitación: &quot;Gestión de la compatibilidad de VEC con los cambios de política de extensión de Chrome&quot;. |
...
|  | [Primeros pasos del administrador](/help/main/administrating-target/start-target.md#admin-permissions) | Se ha agregado una nueva sección: &quot;Permisos necesarios para editar la configuración de [!UICONTROL Administration]&quot;. |
|  | [Administrar [!DNL Target] Información general](/help/main/administrating-target/administrating-target.md) | Se agregó una nota importante acerca de los permisos necesarios para editar la configuración de [!UICONTROL Administration].<P>Se agregó la misma nota a todos los artículos de la sección [!UICONTROL Administration]. |
