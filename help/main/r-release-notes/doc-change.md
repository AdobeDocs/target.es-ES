...
| Marzo de 13 | [Navegadores admitidos](https://experienceleague.adobe.com/en/docs/target-dev/developer/implementation/supported-browsers){target=_blank} | Se han actualizado los navegadores admitidos y se ha agregado la sección &quot;Requisitos de edición visual&quot;. |
...
| Fecha | Tema | Cambios |
|--- |--- |--- |
| 26 de febrero | [[!DNL Target] Notas de la versión (actuales)](/help/main/r-release-notes/release-notes.md) | Se ha añadido información para las siguientes versiones:<ul><li>[!DNL Target Standard/Premium] 25.2.3 (26 de febrero de 2025)</li><li>Versión de at.js versión 2.11.7 (26 de febrero de 2025)</li></ul> |
|  | [Detalles de las versiones de at.js](https://experienceleague.adobe.com/en/docs/target-dev/developer/client-side/at-js-implementation/target-atjs-versions){target=_blank} | Se ha agregado información sobre la versión de at.js versión 2.11.7 (26 de febrero de 2025). |
