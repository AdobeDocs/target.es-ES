...
|  | [Resumen de API de entrega](https://experienceleague.corp.adobe.com/docs/target-dev/developer/api/delivery-api/overview.html){target=_blank} en la *[!DNL Target]Guía para desarrolladores* | Se agregó información sobre la precaución al actualizar [!DNL Recommendations] [!UICONTROL Catalogs] a través de [!DNL Target Delivery API]. |
