...
|  | [Resumen de API de entrega](https://experienceleague.corp.adobe.com/docs/target-dev/developer/api/delivery-api/overview.html){target=_blank} en la *[!DNL Target]Guía para desarrolladores* | Se ha añadido una nota importante. |
