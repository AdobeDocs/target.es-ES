...
|  | [Consideraciones y limitaciones conocidas](https://experienceleague.adobe.com/en/docs/target-dev/developer/api/delivery-api/known-limitations){target=_blank} en la *[!DNL Target]Guía para desarrolladores* | Se agregó información sobre la precaución al actualizar [!DNL Recommendations] [!UICONTROL Catalogs] a través de [!DNL Target Delivery API]. |
