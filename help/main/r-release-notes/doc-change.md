---
keywords: destino registro de cambios de documentación; actualizaciones de documentación; nuevos temas; Ediciones; Actualizaciones; actualizar; Cambios
...
| 8 de abril | [CNAME y Target](https://experienceleague.adobe.com/en/docs/target-dev/developer/implementation/implement-cname-support-in-target){target=_blank} | Se han hecho las actualizaciones siguientes:<ul><li>Todos los certificados son RSA SHA-256 y las claves RSA de 2048 bits de forma predeterminada. Los tamaños de clave superiores a 2048 bits deben solicitarse explícitamente al Servicio de atención al cliente. (Anteriormente, no se admitían tamaños de clave superiores a 2048 bits).</li><li>Se ha actualizado el script bash.</li><li>Se ha actualizado validación fragmento de código de salida.</li></ul> |
| Abril de 7 | [[!DNL Target] Notas de la versión (versión preliminar)](/help/main/r-release-notes/target-release-notes.md) | Se han añadido notas previas a la revisión para la siguiente versión próxima:<UL><li>[!DNL Target Standard/Premium] 25.4.3 (10 de abril de 2025)</li></ul> |
...
| 19 de marzo | [Resolución de problemas relacionados con el [!UICONTROL Enhanced Experience Composer]](/help/main/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/troubleshooting-issues-related-to-the-enhanced-experience-composer-eec.md) | Se han actualizado las direcciones IP a la lista de permitidos. |
| 18 de marzo | [Asistencia y actividades de A4T [!UICONTROL Auto-Allocate] [!UICONTROL Auto-Target]](/help/main/c-integrating-target-with-mac/a4t/a4t-at-aa.md) | Se agregó una nota a la sección *Métricas de objetivo admitidas*. |
...
| Fecha | Tema | Cambios |
|--- |--- |--- |
| 26 de febrero | [[!DNL Target] Notas de la versión (actuales)](/help/main/r-release-notes/release-notes.md) | Se ha agregado información para las siguientes versiones:<ul><li>[!DNL Target Standard/Premium] 25.2.3 (26 de febrero de 2025)</li><li>Versión de at.js versión 2.11.7 (26 de febrero de 2025)</li></ul> |
...
| 12 de febrero | [Opciones del Compositor de experiencias visuales](/help/main/c-experiences/c-visual-experience-composer/viztarget-options.md) | Se ha actualizado todo el tema para explicar el VEC actualizado introducido en la [!DNL Target Standard/Premium] versión 25.2.1 (12 de febrero de 2025). |
|  | [Navegadores admitidos](https://experienceleague.adobe.com/en/docs/target-dev/developer/implementation/supported-browsers){target=_blank} | Se ha añadido información sobre los exploradores compatibles con una Target implementación el archivo [!DNL Adobe Experience Platform Web SDK]. |
|  | [Cambios en el Compositor de experiencias visuales](/help/main/c-experiences/c-visual-experience-composer/vec-changes.md) | Nuevo artículo para explicar las diferencias entre las versiones anterior y actualizada del VEC. |
|  | [[!DNL Target] Notas de la versión (actuales)](/help/main/r-release-notes/release-notes.md) | Se agregó Notas de la versión para la actualización de la interfaz usuario 25.2.1 (programada para el [!DNL Target Standard/Premium] 17 de febrero de 2025). Muchos artículos se actualizaron para reflejar los cambios IU. |
...
| 22 de enero | [Extensión Ayuda de edición visual](/help/main/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/visual-editing-helper-extension.md) | El nuevo [!UICONTROL Visual Editing Helper Extension] ahora soporta [!DNL Private Chrome Web Stores]. Se ha eliminado una nota que indicaba que los clientes que usaban [!DNL Private Chrome Web Stores] seguían usando el archivo .[!UICONTROL Visual Experience Composer helper extension] |
| 7 de enero | [Notas de la versión (actual) de Target](/help/main/r-release-notes/release-notes.md) | Se agregó Notas de la versión para la actualización de la interfaz del usuario (programada para el [!UICONTROL Offers Library] 9 de enero de 2025). Todos los artículos de Ofertas se actualizaron para reflejar los cambios en la interfaz de usuario. |