...
| Fecha | Tema | Cambios |
|--- |--- |--- |
| Julio de 21 | [[!DNL Target] Preguntas frecuentes sobre la actualización de IU](/help/main/c-intro/updated-ui-faq.md#collapse) | Se ha agregado una nueva pregunta frecuente: ¿Puedo contraer los carriles [!UICONTROL Components], [!UICONTROL Modifications] y [!UICONTROL Properties] para poder ampliar el panel [!UICONTROL Design]? |
