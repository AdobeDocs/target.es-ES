...
| Fecha | Tema | Cambios |
|--- |--- |--- |
| Julio de 7 | [[!DNL Target] Notas de la versión (actuales)](/help/main/r-release-notes/release-notes.md) | Se agregó una nueva sección para resaltar información con distinción de tiempo acerca de [!DNL Target] y su implementación. |
