...
* Se ha agregado la capacidad de filtrar [!DNL Adobe Experience Manager] (AEM) [fragmentos de experiencia](/help/main/c-experiences/c-manage-content/aem-experience-fragments.md) por tipo (HTML o JSON) en la variable [!UICONTROL Ofertas] lista. (TGT-43121)
