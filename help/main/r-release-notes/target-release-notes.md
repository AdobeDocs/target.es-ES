...
+++Ver detalles
* **Se ha corregido un problema en la interfaz de usuario de Recommendationsen el cual la descarga CSV con criterios personalizados arrojaba un error 404**: se ha corregido un problema en el cual los clientes no podían descargar el CSV con criterios personalizados en el proceso de creación de actividades. El vínculo de descarga ahora funciona correctamente, lo que permite a los clientes exportar criterios personalizados según lo esperado. (TGT-51966)
