...
>[!IMPORTANT]
>
>El equipo [!DNL Target] ha ajustado la cronología para la desaprobación de la versión de la interfaz de usuario. Consulte [Actualización: [!DNL Target] Desaprobación de la opción de versión de IU (17 de junio de 2025)](/help/main/r-release-notes/release-notes.md#revised) para obtener más información.
