...
Usar audiencias en [!DNL Adobe Target] para dirigirse a los usuarios según su ubicación geográfica.
...
1. Arrastrar y soltar **[!UICONTROL Geografía]** en el panel del generador de audiencias.
...
Puede usar `profile.geolocation` directamente como tokens en ofertas, complementos, etc.
