...
seo-description: Las actividades de Adobe Target permiten probar diseños de página y dirigir contenido a audiencias específicas.
...
La lista [!UICONTROL Actividades] es la vista predeterminada al abrirla [!DNL Target]. Puede crear nuevas actividades desde esta página y administrar las actividades existentes.

También puede mostrar la lista [!UICONTROL Actividades] haciendo clic en la ficha [!UICONTROL Actividades] en la parte superior de la interfaz de [!DNL Target] usuario.
...
![Acciones de lista de actividades al pasar sobre](/help/c-activities/assets/activities_list_hover.png)

Están disponibles las siguientes acciones (según sus permisos):
...
| Eliminar | Elimina una actividad preparada o en el estado de borrador. Las actividades eliminadas no se pueden recuperar. |
...
## Clasificación y filtrado de la lista Actividades {#section_41DAD479FFF740E2BB67BF4825955670}
...
### Filtros de lista de actividades

Puede seleccionar filtros de la lista de actividades para determinar qué actividades aparecen en la lista.

![Filtrar actividades por tipo](/help/c-activities/assets/activities_filters_new.png)
...
|--- |--- |
| Tipo | Prueba A/B: [Manual](/help/c-activities/t-test-ab/test-ab.md), [asignación automática](/help/c-activities/automated-traffic-allocation/automated-traffic-allocation.md)y [segmentación automática](/help/c-activities/auto-target-to-optimize.md).<br>[Personalizacionescompatibilidad con el objetivo multivariate](/help/c-activities/t-automated-personalization/automated-personalization.md)<br>[](/help/c-activities/t-experience-target/experience-target.md)<br>[testrecomendaciones](/help/c-activities/c-multivariate-testing/multivariate-testing.md)<br>[](/help/c-recommendations/recommendations.md) |
| Estado | Activa<br>Borrador<br>Programada<br>Inactiva<br>Sincronizando<br>Completada<br>Archivada |
| Fuente de informes | Targetanalytics<br> |
...
### Ordenar por atributo de actividad
...
![Lista de actividades orden ascendente](/help/c-activities/assets/activities_list_ascending.png)

## Consejos y trucos {#section_F77F30A246A14B538D9363B7F3639F97}
...
![Deshabilitar la punta del día](/help/c-activities/assets/tip-disable-new.png)
...
### Administración de actividades (5:55)
