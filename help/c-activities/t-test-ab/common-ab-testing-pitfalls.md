...
description: Aprenda a evitar los inconvenientes y errores más comunes que las empresas cometen al realizar pruebas A/B en Adobe [!DNL Target] y otras soluciones de prueba.
...
# Diez escollos comunes de las pruebas A/B y cómo evitarlos

Las pruebas A/B en [!DNL Adobe Target] constituyen la columna vertebral de la mayoría de los programas de optimización de marketing digital, y ayudan a los especialistas en marketing a ofrecer experiencias optimizadas y dirigidas a sus visitantes y clientes. Esta sección describe diez de los escollos más importantes a los que se enfrentan las empresas al realizar pruebas A/B. También se explican las formas de evitarlos para que las empresas puedan obtener un ROI más elevado a través de los procesos de prueba y confiar más en los resultados que arrojan las pruebas A/B.
...
## Escollo 2: Declarar ganadores de varias pruebas de oferta sin una diferencia estadísticamente significativa {#section_FA83977C71DB4F69B3D438AF850EF3B6}
...
## Escollo 5: Pruebas de monitorización {#section_EA42F8D5967B439284D863C46706A1BA}
...
## Escollo 6: Deteniendo las pruebas antes de {#section_DF01A97275E44CA5859D825E0DE2F49F}
...
## Escollo 7: Cambio de la asignación de tráfico durante el período de prueba {#allocation}
...
Otro ejemplo: si la asignación de tráfico de la prueba A/B se divide 50/50 y, a continuación, cambia la división a 80/20, durante los primeros días después de ese cambio, los resultados podrían parecer distorsionados. Si el tiempo promedio de conversión es alto, lo que significa que alguien tarda varias horas o incluso días en realizar una compra, estas conversiones demoradas pueden afectar a los informes. Por lo tanto, en esa primera experiencia, en la que el número pasó del 50 % al 80 % y el tiempo medio de conversión es de dos días, solo los visitantes del 50 % de la población se están convirtiendo el primer día de la prueba, aunque actualmente el 80 % de la población está entrando en la experiencia. Esto hace que parezca que la tasa de conversión se desplomó, pero se normalizará nuevamente después de que el 80 % de los visitantes hayan tardado dos días en realizar la conversión.

## Escollo 8: No se tienen en cuenta los efectos de la novedad {#section_90F0D24C40294A8F801B1A6D6DEF9003}
...
## Escollo 9: No se tienen en cuenta las diferencias en el período de consideración {#section_B166731B5BEE4E578816E351ECDEA992}
...
## Escollo 10: Uso de métricas que no reflejan los objetivos del negocio {#section_F0CD6DC7993B4A6F9BEEBB31CD1D9BEE}
...
## Conclusión: Éxito con las pruebas A/B al reconocer y sortear los escollos {#section_54D33248163A481EBD4421A786FE2B15}
