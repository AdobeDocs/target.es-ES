...
Use el [!UICONTROL Compositor de experiencias visuales] (VEC) en [!DNL Adobe Target] para crear su actividad [!UICONTROL Prueba A/B] directamente en una página [!DNL Target] habilitada y para modificar partes de la página en [!DNL Target].
