...
seo-title: Segmentación automática
solution: Target
...
>[!NOTE]
>
>La [!UICONTROL segmentación automática] está disponible como parte de la solución [!DNL Target Premium]. Esta característica no está disponible en [!DNL Target Standard] sin una licencia de [!DNL Target Premium].
...
Para ajustar el porcentaje de control, haga clic en los signos - o +. No se puede reducir el grupo de control por debajo del 10 %.
