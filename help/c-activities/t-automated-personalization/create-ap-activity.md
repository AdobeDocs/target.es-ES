...
1. Especifique el canal deseado: web.
   ...
   También puede elegir Aplicación móvil, Correo electrónico u Otros/API.
...
1. Configure la actividad con las siguientes opciones y, a continuación, haga clic en **[!UICONTROL Guardar y cerrar]**.
   ...
   | Métrica de conversión | De forma predeterminada, la métrica de conversión es igual que la métrica de objetivo de optimización. Sin embargo, puede definir una métrica de conversión independiente desmarcando la opción [!UICONTROL Igual que el objetivo] de optimización. |
