...
description: Determine un ganador en una actividad A/B de asignación automática mediante la visualización de indicadores en la interfaz de usuario de Adobe Target.
