...
+ Administración de Target {#administer}
   ...
   + Definir preferencias {#preferences}
      + [Preferencias](administrating-target/r-target-account-preferences/target-account-preferences.md)
      + [Estimar el aumento de ingresos](administrating-target/r-target-account-preferences/estimating-lift-in-revenue.md)
...
+ Implementación de Target {#implement-target}
   ...
   + Antes de la implementación {#before-implement}
      ...
      + [Comprender las bibliotecas JavaScript de Target](c-implementing-target/c-considerations-before-you-implement-target/target-implement.md)
   ...
   + Web del lado del cliente: implementación de Target {#client-side}
      + [Información general: implementar Target para la Web del lado del cliente](/help/c-implementing-target/c-implementing-target-for-client-side-web/implement-target-for-client-side-web.md)
      ...
      + [Actualización desde at. js 1. x a at. js 2. x](c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md)
      ...
      + Implementación de mbox.js {#mbox-implement}
         ...
         + Comprender el mbox global {#global-mbox}
            + [Información general para comprender el mbox global](c-implementing-target/c-implementing-target-for-client-side-web/t-mbox-download/c-understanding-global-mbox/understanding-global-mbox.md)
   ...
   + Target para aplicaciones móviles {#mobile-apps}
      ...
      + Compositor de experiencias visuales para aplicaciones móviles {#composer}
         + [Compositor de experiencias visuales para aplicaciones móviles](c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer.md)
...
+ Integración de Adobe Target con Experience Cloud {#integrate}
   + Adobe Analytics como fuente de informes para Adobe Target (A4T) {#a4t}
      ...
      + [Creación de actividad](c-integrating-target-with-mac/a4t/campaign-creation.md)
...
+ Actividades {#activities}
   ...
   + Prueba A/B{#abtest} 
      ...
      + Crear una prueba A/B {#create}
         ...
         + [Varias versiones de una experiencia en una prueba A/B](c-activities/t-test-ab/t-test-create-ab/target-experience-to-multiple-audiences.md)
   ...
   + Personalización automatizada {#automated-personalization}
      ...
      + [Compartir URL de experiencia para previsualizar la personalización automatizada fuera de Target](c-activities/t-automated-personalization/experience-preview.md)
   ...
   + [Notificaciones de actividades](c-activities/notifications.md)
