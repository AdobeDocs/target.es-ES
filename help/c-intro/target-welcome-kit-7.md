...
description: Kit de bienvenida de Adobe Target - Capítulo 7
title: Kit de bienvenida de Adobe Target - Capítulo 7
feature: intro
...
* **Usa lo que sabes.** Tal vez ya conoce bien a sus clientes y tenga una buena idea de lo que va a resonar con ellos. Utilícelo para desarrollar experiencias personalizadas.
* **Utilice su solución de análisis.** Busque los lugares del sitio donde los clientes abandonaron el flujo de compras o salieron de una página. Revise las páginas y la hipótesis de lo que podría hacer que se retiren antes de realizar la acción deseada.
* **Usa tus poderes de observación.** Observe algunas páginas clave de su sitio Web y utilice su sensación intestinal para identificar las cosas que necesitan mejoras. Tal vez una página de detalles del producto que está demasiado llena y llena de palabras, así que simplifíquela. Quizás sea difícil encontrar un botón de compra, así que muévalo a una ubicación más visible.
* **Mira a tus competidoras.** Una rápida revisión de los sitios web de sus competidoras puede revelar diseños, ofertas, copias y otros elementos que usted cree que son muy eficaces para generar resultados comerciales. Considere maneras de probar esos enfoques en el sitio.
* **Puntee en los comentarios del cliente.** Es posible que sus clientes le hayan dado ideas para mejorar su experiencia a través de una encuesta en línea o en llamadas de servicio al cliente. Identifique un punto problemático que varios hayan mencionado y obtenga una experiencia que pueda eliminarlo.

Cuando llegue a la idea de realizar pruebas, tenga en cuenta que debería poder explicar, idealmente con datos, por qué cree que la idea de prueba propuesta puede mejorar la experiencia del cliente y las métricas que le importan al negocio.

## Planificación de la actividad con el planificador de Actividades

Hemos incluido el siguiente planificador de Actividad como PDF independiente (véase más adelante) que puede guardar y usar una y otra vez. Para ejecutar una actividad efectiva, debe completar cada área del planificador. Utilice esta herramienta a medida que usted y otros usuarios inician ideas para probar y personalizar actividades.

![Adobe Target Actividad Planner](/help/c-intro/assets/activity-planner.png)

Este es el tipo de pensamiento que va a cada área del planificador:

### ¿Qué se puede mejorar?

Seleccione el canal o punto de contacto que desea mejorar. Añada la dirección URL del elemento o descríbalo. En este caso, agregará la dirección URL de la página web para la que tiene previsto crear una variación de prueba o una experiencia personalizada.

### ¿Cuál es tu hipótesis?

Explique claramente cuál es el problema con la experiencia actual de la página web, incluidos los datos o fuentes que haya utilizado para identificar el problema. Explicar qué piensa cambiar y por qué cree que mejorará la experiencia del cliente. Por último, explique el resultado que espera y describa el valor comercial en las métricas de éxito del negocio que cree que esta nueva experiencia proporcionará.
...
Describa las métricas comerciales que utilizará como indicador del éxito de su actividad. Por ejemplo: aumento de ingresos por visitante (RPV), tasa de conversión o valor de pedido promedio (AOV). Cuanto más pueda relacionar el impacto con el balance final del negocio, mejor, por lo que si puede relacionar el impacto con los ingresos, es ideal.
...
### ¿Qué recursos o equipos necesitan participar?

Si la actividad requiere el documento de un diseñador, un desarrollador web o un analista de datos, explique lo que tendrá que hacer como parte de la actividad.

### Si se ejecuta una prueba, ¿durante cuánto tiempo debe ejecutarse para que alcance relevancia?
...
Ninguna organización tiene recursos ilimitados para ejecutar todas las actividades de pruebas y personalización que desea. Utilice esta área para asignar un número, por ejemplo, de 1 a 5 o una etiqueta con valor bajo, medio o alto para reflejar la importancia relativa de esta actividad para la empresa. En muchos casos, la priorización de una actividad se realiza teniendo en cuenta el nivel de esfuerzo, tiempo y costo para configurar una actividad en comparación con el nivel de rendimiento que podría ofrecer.

### ¿Cuáles son los resultados?

Una vez finalizada la actividad, documento los resultados, asegurándose de enlazar dichos resultados con la hipótesis original, con cualquier audiencia importante que haya utilizado en la actividad y con las métricas de éxito primarias y secundarias antes indicadas, para las que pretendía evaluar los resultados de la actividad. El siguiente capítulo trata sobre la comunicación de esos resultados de actividad.

### ¿Qué hay que refinar en la actividad/Qué pasos se deben dar a continuación?

Los resultados de la actividad a menudo proporcionan perspectivas sobre las acciones que debe realizar a continuación. Si una variación de experiencia ha tenido un éxito absoluto, puede que desee codificarla en el sitio web. Es posible que vea oportunidades para aplicar ese éxito en otras páginas similares. Los resultados podrían indicar que se debe trabajar más para mejorar la experiencia del cliente en esta página. Utilice esta área para documento de los conocimientos clave de la actividad y para el documento de lo que hará en función de dichos conocimientos.
