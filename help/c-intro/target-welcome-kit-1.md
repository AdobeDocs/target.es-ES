...
description: Haga clic en inicio su programa de optimización y personalización con Adobe Target. El kit de bienvenida de Adobe Target es un buen punto de partida.
title: ¿Cómo empiezo con el Destinatario?
feature: Overview
...
Para ayudarle, hemos creado este kit de bienvenida, con información, herramientas y recursos clave que le ayudarán a prepararse para su primera [!DNL Target] actividad y a iniciarla. A largo plazo, estos contenidos también proporcionan la base para crear un programa de optimización y personalización exitoso.
