---
description: Información sobre el uso de VEC (Visual Experience Composer).
seo-description: Información sobre el uso de VEC (Visual Experience Composer) en Adobe Target.
seo-title: Compositor de experiencias visuales (VEC) de Adobe Target
title: Compositor de experiencias visuales (VEC)
...
El VEC es una interfaz de usuario WYSIWYG que permite crear y probar fácilmente experiencias y ofertas personalizadas en el contexto del sitio. Puede crear experiencias y ofertas para actividades de Target arrastrando y soltando, intercambiando y modificando el diseño y el contenido de una página Web (o oferta) o una página Web móvil.

El VEC es una de las características principales de [!DNL Adobe Target]. El VEC permite a los comerciantes y diseñadores crear y cambiar contenido mediante una interfaz visual. Se pueden elegir muchas opciones de diseño sin tener que editar directamente el código. Editar HTML y JavaScript también es posible con las opciones de edición que se encuentran disponibles en el compositor.
...
Esta URL determina dónde se empieza al abrir el VEC. Si no establece un valor predeterminado, comenzará con una página en blanco cuando abra el editor y deberá indicar una dirección URL entonces.

>[!NOTE]
>
>Algunos exploradores, como Firefox, podrían bloquear una página para que se muestre en el VEC si la página contiene contenido mixto (por ejemplo, una página no segura en un sitio seguro). Si la página no se muestra, haga clic en el icono situado junto a la URL en la barra de direcciones del explorador y haga clic **[!UICONTROL en Deshabilitar protección en esta página]**. Este problema no afecta a la visualización de las páginas de los visitantes del sitio.

El contenido dentro de un iframe en la página no se puede modificar en el VEC. Para editar contenido dentro de un iframe, asegúrese de que el documento de iframe esté habilitado para Target y, a continuación, cargue la URL del iframe en el VEC.
...
Haga clic en el icono **[!UICONTROL Superposiciones]** para cambiar la forma en que se muestra el resaltado. Por ejemplo, puede elegir resaltar solo imágenes, vínculos, mboxes regionales, modificaciones o JavaScript. Puede cambiar el color del resaltado. También puede especificar el color de resaltado y el tipo de relleno usado para resaltar distintos tipos de elementos.

![Cambiar la configuración de superposición](/help/c-experiences/c-visual-experience-composer/assets/change-overlay.png)

Haga clic en un elemento resaltado para ver un menú de opciones disponibles para ese tipo de elemento. Por ejemplo, haga clic en una imagen y seleccione **[!UICONTROL Editar &gt; Texto/HTML]** para cambiar el texto, o haga clic en un botón y cambie el color de fondo. Puede usar los botones de la parte superior izquierda para activar y desactivar las superposiciones.
...
Para obtener más información sobre las opciones disponibles en el VEC, consulte [Opciones del Compositor de experiencias visuales](../../c-experiences/c-visual-experience-composer/viztarget-options.md#reference_3BD1BEEAFA584A749ED2D08F14732E81).

Puede realizar algunas modificaciones en una página mientras se carga la página (o después de que la página no se haya cargado), o puede cancelar la carga de páginas en el VEC. Para obtener más información, consulte:

* [Editar una página mientras se carga la página o después de que la página no se haya cargado](#loading)
...
Algunas razones por las cuales es posible que desee acceder o editar una página mientras ésta se carga dentro del VEC o después de cargarla:

* Desea realizar una modificación sencilla de una página, como agregar código personalizado o cambiar el nombre de una experiencia
* Desea copiar código personalizado existente de una página que ya no sea accesible
* Sabe que una página no se carga dentro del VEC pero desea realizar ediciones simples de todas maneras

Mientras la página se carga (o después de que no se cargue), el [!UICONTROL panel Experiencias] , [!UICONTROL el panel Modificaciones] y la configuración en la parte superior de la experiencia (Superposiciones, Modificaciones, Configurar, etc.) son accesibles.
...
* Incorrecto introdujo la dirección URL incorrecta para la página
...
* Desea anular el compositor de experiencias mejorado global (EEC) al cargar una página a través del EEC o de solo iframe podría variar la página a la página
...
>[!IMPORTANT]
>
>Tenga en cuenta que cuando se realiza un código personalizado o se realizan modificaciones, al elegir cancelar la carga dentro del VEC, debe asegurarse de que la codificación o los cambios se realicen correctamente. Asegúrese de realizar un control de calidad adecuado para garantizar que el código personalizado y cualquier otra modificación se entregue según lo esperado.

Para cancelar la carga de una página dentro del VEC, haga clic en el **[!UICONTROL botón Cancelar carga]** mientras se carga la página. La página no se cargará en el VEC para esta actividad durante la sesión de edición actual.

![Cancelar carga, botón](/help/c-experiences/c-visual-experience-composer/c-vec-code-editor/assets/cancel-loading.png)
...
>[!NOTE]
>
>Existe un problema conocido actualmente con esta función que se solucionará en la próxima versión. Para obtener más información, consulte «Cancelar carga de una página dentro del VEC» en los problemas [conocidos y en la página de problemas](/help/r-release-notes/known-issues-resolved-issues.md#cancel) resueltos.

## Vídeos de formación

Los siguientes vídeos contienen más información sobre los conceptos mencionados en este artículo.

### Compositor de experiencias visuales (7:17)
