...
El artefacto de regla es una representación JSON de sus actividades de decisiones en el dispositivo [!DNL Adobe Target]. El artefacto de regla lo genera [!DNL Target] y se propaga a la CDN de Akamai para garantizar que haya un artefacto de regla disponible lo más cerca posible de sus visitantes. El artefacto de la regla contiene metadatos que garantizan la ejecución y el envío precisos de sus actividades, además de permitir análisis en tiempo real mediante seguimiento de eventos.
