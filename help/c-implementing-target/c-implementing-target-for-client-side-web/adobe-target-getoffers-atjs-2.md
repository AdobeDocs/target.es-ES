...
description: Utilice la función adobe.target.getOffers() y sus opciones para que la biblioteca at.js de Adobe Target active solicitudes para obtener varias ofertas de Target. (at.js 2.x)
