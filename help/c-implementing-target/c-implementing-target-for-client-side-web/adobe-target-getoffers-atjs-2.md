...
description: Utilice la función adobe.target.getOffers() y sus opciones para el Adobe [!DNL Target] at.js library to fire requests to get multiple [!DNL Target] ofertas. (at.js 2.x)
