...
description: Utilice la función adobe.target.getOffer() y sus opciones para la oferta de Adobe [!DNL Target] at.js library to fire requests to get a [!DNL Target] .
