...
1. Seleccione el **[!UICONTROL Fuente de datos de comportamiento]**: [!UICONTROL Adobe Target] o [!UICONTROL Analytics].
   ...
   >[!NOTE]
   >
   >La variable [!UICONTROL Fuente de datos de comportamiento] solo se muestra si su implementación utiliza [Analytics para Target](/help/c-integrating-target-with-mac/a4t/a4t.md) (A4T).
