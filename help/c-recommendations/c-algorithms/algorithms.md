...
>[!NOTE]
>
>Los parámetros de perfil personalizados se pueden pasar a [!DNL Target] mediante JavaScript, API o integraciones. Para obtener más información sobre los atributos de perfil personalizados, consulte [Perfiles de los visitantes](/help/c-target/c-visitor-profile/visitor-profile.md).
...
1. Rellene la información de la sección [Sección Información básica](/help/c-recommendations/c-algorithms/create-new-algorithm.md#info).

1. En el [Algoritmo recomendado](/help/c-recommendations/c-algorithms/create-new-algorithm.md#rec-algo) , seleccione **[!UICONTROL Basado en elementos]** de la variable **[!UICONTROL Tipo de algoritmo]** lista.
