...
description: Obtenga información sobre cómo seleccionar los criterios (reglas que determinan qué productos o contenido recomendar) que se utilizarán en la actividad de Adobe Target Recommendations.
title: ¿Cómo se seleccionan los criterios para una Actividad de Recommendations?
